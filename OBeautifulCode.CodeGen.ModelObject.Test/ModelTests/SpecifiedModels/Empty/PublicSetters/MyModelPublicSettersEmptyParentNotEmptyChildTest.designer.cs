            ...
            .AddScenario(
                new EquatableTestScenario<MyModelPublicSettersEmptyParentNotEmptyChild>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new MyModelPublicSettersEmptyParentNotEmptyChild[]
                    {
                        new MyModelPublicSettersEmptyParentNotEmptyChild
                            {
                                ChildReadOnlyDictionaryOfStringString = A.Dummy<IReadOnlyDictionary<string, string>>().ThatIsNot(ReferenceObjectForEquatableTestScenarios.ChildReadOnlyDictionaryOfStringString),
                            },
                    },
