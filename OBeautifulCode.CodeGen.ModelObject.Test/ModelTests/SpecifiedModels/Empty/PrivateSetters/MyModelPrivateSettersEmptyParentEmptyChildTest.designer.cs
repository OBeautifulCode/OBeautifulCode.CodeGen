...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelPrivateSettersEmptyParentEmptyChildTest
    {
        ...
        private static readonly DeepCloneWithTestScenarios<MyModelPrivateSettersEmptyParentEmptyChild> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MyModelPrivateSettersEmptyParentEmptyChild>();
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                {
                    // Arrange, Act
                    var actual = (MyModelPrivateSettersEmptyParentEmptyChild)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(MyModelPrivateSettersEmptyParentEmptyChild).GetProperty(propertyName);
