...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelPrivateSettersEmptyParentTest
    {
        ...
        private static readonly DeepCloneWithTestScenarios<MyModelPrivateSettersEmptyParent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MyModelPrivateSettersEmptyParent>();

        private static readonly MyModelPrivateSettersEmptyParent ReferenceObjectForEquatableTestScenarios = A.Dummy<MyModelPrivateSettersEmptyParent>();

        private static readonly EquatableTestScenarios<MyModelPrivateSettersEmptyParent> EquatableTestScenarios = new EquatableTestScenarios<MyModelPrivateSettersEmptyParent>()
            .AddScenario(() =>
                new EquatableTestScenario<MyModelPrivateSettersEmptyParent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new MyModelPrivateSettersEmptyParent[]
                    {
                    ...
                    {
                        A.Dummy<MyModelPrivateSettersEmptyParent>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void MyModelPrivateSettersEmptyParent___Should_implement_IModel_of_MyModelPrivateSettersEmptyParent___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPrivateSettersEmptyParent);

                var expectedModelMethods = typeof(IModel<MyModelPrivateSettersEmptyParent>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<MyModelPrivateSettersEmptyParent>));
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelPrivateSettersEmptyParent>();

                // Act
                var actual = (MyModelPrivateSettersEmptyParent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                {
                    // Arrange, Act
                    var actual = (MyModelPrivateSettersEmptyParent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(MyModelPrivateSettersEmptyParent).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<MyModelPrivateSettersEmptyParent>();
                ...
                // Act
                var actual = serializer.Deserialize<MyModelPrivateSettersEmptyParent>(serializedBson);
            ...
            public static void Deserialize___Should_roundtrip_object___When_serializing_to_and_deserializing_from_string_using_ObcJsonSerializer()
            {
                ...
                // Act
                var actual = serializer.Deserialize<MyModelPrivateSettersEmptyParent>(serializedJson);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                MyModelPrivateSettersEmptyParent systemUnderTest1 = null;
                MyModelPrivateSettersEmptyParent systemUnderTest2 = null;
