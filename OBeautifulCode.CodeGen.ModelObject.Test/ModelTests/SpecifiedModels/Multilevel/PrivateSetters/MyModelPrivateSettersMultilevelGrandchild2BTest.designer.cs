...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelPrivateSettersMultilevelGrandchild2BTest
    {
        ...
        private static readonly StringRepresentationTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<MyModelPrivateSettersMultilevelGrandchild2B>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<MyModelPrivateSettersMultilevelGrandchild2B>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<MyModelPrivateSettersMultilevelGrandchild2B>
                        {
                            SystemUnderTest = new MyModelPrivateSettersMultilevelGrandchild2B(
        ...
        private static readonly DeepCloneWithTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MyModelPrivateSettersMultilevelGrandchild2B>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MyModelPrivateSettersMultilevelGrandchild2B>().ThatIs(_ => !systemUnderTest.ParentInt.IsEqualTo(_.ParentInt));

                        var result = new SystemUnderTestDeepCloneWithValue<MyModelPrivateSettersMultilevelGrandchild2B>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MyModelPrivateSettersMultilevelGrandchild2B>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MyModelPrivateSettersMultilevelGrandchild2B>().ThatIs(_ => !systemUnderTest.Child2Int.IsEqualTo(_.Child2Int));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MyModelPrivateSettersMultilevelGrandchild2B>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MyModelPrivateSettersMultilevelGrandchild2B>().ThatIs(_ => !systemUnderTest.Grandchild2BInt.IsEqualTo(_.Grandchild2BInt));
        ...
        private static readonly EquatableTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B> EquatableTestScenarios = new EquatableTestScenarios<MyModelPrivateSettersMultilevelGrandchild2B>()
            .AddScenario(() =>
                new EquatableTestScenario<MyModelPrivateSettersMultilevelGrandchild2B>
                {
                    ...
                    {
                        new MyModelPrivateSettersMultilevelGrandchild2B(
                                A.Dummy<MyModelPrivateSettersMultilevelGrandchild2B>().Whose(_ => !_.ParentInt.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentInt)).ParentInt,
                                ReferenceObjectForEquatableTestScenarios.Child2Int,
                                ReferenceObjectForEquatableTestScenarios.Grandchild2BInt),
                        new MyModelPrivateSettersMultilevelGrandchild2B(
                                ReferenceObjectForEquatableTestScenarios.ParentInt,
                                A.Dummy<MyModelPrivateSettersMultilevelGrandchild2B>().Whose(_ => !_.Child2Int.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Child2Int)).Child2Int,
                                ReferenceObjectForEquatableTestScenarios.Grandchild2BInt),
                        new MyModelPrivateSettersMultilevelGrandchild2B(
                                ReferenceObjectForEquatableTestScenarios.ParentInt,
                                ReferenceObjectForEquatableTestScenarios.Child2Int,
                                A.Dummy<MyModelPrivateSettersMultilevelGrandchild2B>().Whose(_ => !_.Grandchild2BInt.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Grandchild2BInt)).Grandchild2BInt),
                    },
        ...
        public static class Structural
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelPrivateSettersMultilevelGrandchild2B___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPrivateSettersMultilevelGrandchild2B);
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (MyModelPrivateSettersMultilevelGrandchild2B)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(MyModelPrivateSettersMultilevelGrandchild2B).GetProperty(propertyName);
