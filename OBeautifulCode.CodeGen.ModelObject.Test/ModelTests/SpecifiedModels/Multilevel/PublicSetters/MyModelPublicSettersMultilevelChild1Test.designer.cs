...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelPublicSettersMultilevelChild1Test
    {
        ...
        private static readonly DeepCloneWithTestScenarios<MyModelPublicSettersMultilevelChild1> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MyModelPublicSettersMultilevelChild1>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MyModelPublicSettersMultilevelChild1>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MyModelPublicSettersMultilevelChild1>().ThatIs(_ => !systemUnderTest.ParentInt.IsEqualTo(_.ParentInt));

                        var result = new SystemUnderTestDeepCloneWithValue<MyModelPublicSettersMultilevelChild1>
                        {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MyModelPublicSettersMultilevelChild1>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MyModelPublicSettersMultilevelChild1>().ThatIs(_ => !systemUnderTest.Child1Int.IsEqualTo(_.Child1Int));
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (MyModelPublicSettersMultilevelChild1)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(MyModelPublicSettersMultilevelChild1).GetProperty(propertyName);
