// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelHashingPublicSetMiscParentTest.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelHashingPublicSetMiscParentTest
    {
        ...
        private static readonly ModelHashingPublicSetMiscParent ObjectThatIsEqualToButNotTheSameAsReferenceObject = A.Dummy<ModelHashingPublicSetMiscParent>().Whose(_ => _.GetType() == ReferenceObjectForEquatableTestScenarios.GetType());

        private static readonly EquatableTestScenarios<ModelHashingPublicSetMiscParent> LocalEquatableTestScenarios = new EquatableTestScenarios<ModelHashingPublicSetMiscParent>()
            .AddScenario(() =>
        ...
        static ModelHashingPublicSetMiscParentTest()
        {
