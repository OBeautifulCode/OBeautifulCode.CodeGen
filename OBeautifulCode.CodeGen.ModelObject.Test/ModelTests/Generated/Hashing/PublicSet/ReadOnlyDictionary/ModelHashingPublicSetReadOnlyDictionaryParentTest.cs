// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelHashingPublicSetReadOnlyDictionaryParentTest.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelHashingPublicSetReadOnlyDictionaryParentTest
    {
        ...
        private static readonly ModelHashingPublicSetReadOnlyDictionaryParent ObjectThatIsEqualToButNotTheSameAsReferenceObject = A.Dummy<ModelHashingPublicSetReadOnlyDictionaryParent>().Whose(_ => _.GetType() == ReferenceObjectForEquatableTestScenarios.GetType());

        private static readonly EquatableTestScenarios<ModelHashingPublicSetReadOnlyDictionaryParent> LocalEquatableTestScenarios = new EquatableTestScenarios<ModelHashingPublicSetReadOnlyDictionaryParent>()
            .AddScenario(() =>
        ...
        static ModelHashingPublicSetReadOnlyDictionaryParentTest()
        {
