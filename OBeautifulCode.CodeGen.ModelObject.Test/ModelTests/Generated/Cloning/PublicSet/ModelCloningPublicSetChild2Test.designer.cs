...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetChild2Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSetChild2___Should_implement_IDeepCloneable_of_ModelCloningPublicSetChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetChild2);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetChild2>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetChild2);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetChild2>();

                // Act
                var actual = (ModelCloningPublicSetChild2)systemUnderTest.Clone();
