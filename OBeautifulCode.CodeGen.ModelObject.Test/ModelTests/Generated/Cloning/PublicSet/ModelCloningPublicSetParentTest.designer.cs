...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSetParent___Should_implement_IDeepCloneable_of_ModelCloningPublicSetParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetParent);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetParent>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetParent>();

                // Act
                var actual = (ModelCloningPublicSetParent)systemUnderTest.Clone();
