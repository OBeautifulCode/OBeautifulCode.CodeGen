...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelCloningPublicSetParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void MyModelCloningPublicSetParent___Should_implement_IDeepCloneable_of_MyModelCloningPublicSetParent___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPublicSetParent);

                var expectedModelMethods = typeof(IDeepCloneable<MyModelCloningPublicSetParent>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<MyModelCloningPublicSetParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelCloningPublicSetParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPublicSetParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelCloningPublicSetParent>();

                // Act
                var actual = (MyModelCloningPublicSetParent)systemUnderTest.Clone();
