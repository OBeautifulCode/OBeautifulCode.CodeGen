...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelCloningPublicSetChild2Test
    {
        ...
        public static class Structural
        {
            ...
            public static void MyModelCloningPublicSetChild2___Should_implement_IDeepCloneable_of_MyModelCloningPublicSetChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPublicSetChild2);

                var expectedModelMethods = typeof(IDeepCloneable<MyModelCloningPublicSetChild2>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<MyModelCloningPublicSetChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelCloningPublicSetChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPublicSetChild2);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelCloningPublicSetChild2>();

                // Act
                var actual = (MyModelCloningPublicSetChild2)systemUnderTest.Clone();
