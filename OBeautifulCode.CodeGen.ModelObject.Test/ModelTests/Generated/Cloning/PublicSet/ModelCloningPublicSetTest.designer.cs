...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSet___Should_implement_IDeepCloneable_of_ModelCloningPublicSet___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSet);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSet>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSet>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSet___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSet);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSet>();

                // Act
                var actual = (ModelCloningPublicSet)systemUnderTest.Clone();
