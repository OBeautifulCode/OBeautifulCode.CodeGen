...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelCloningPublicSetTest
    {
        ...
        public static class Structural
        {
            ...
            public static void MyModelCloningPublicSet___Should_implement_IDeepCloneable_of_MyModelCloningPublicSet___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPublicSet);

                var expectedModelMethods = typeof(IDeepCloneable<MyModelCloningPublicSet>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<MyModelCloningPublicSet>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelCloningPublicSet___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPublicSet);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelCloningPublicSet>();

                // Act
                var actual = (MyModelCloningPublicSet)systemUnderTest.Clone();
