...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetParent___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetParent);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetParent>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetParent>();

                // Act
                var actual = (ModelCloningPrivateSetParent)systemUnderTest.Clone();
