...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelCloningPrivateSetChild2Test
    {
        ...
        public static class Structural
        {
            ...
            public static void MyModelCloningPrivateSetChild2___Should_implement_IDeepCloneable_of_MyModelCloningPrivateSetChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPrivateSetChild2);

                var expectedModelMethods = typeof(IDeepCloneable<MyModelCloningPrivateSetChild2>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<MyModelCloningPrivateSetChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelCloningPrivateSetChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPrivateSetChild2);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelCloningPrivateSetChild2>();

                // Act
                var actual = (MyModelCloningPrivateSetChild2)systemUnderTest.Clone();
