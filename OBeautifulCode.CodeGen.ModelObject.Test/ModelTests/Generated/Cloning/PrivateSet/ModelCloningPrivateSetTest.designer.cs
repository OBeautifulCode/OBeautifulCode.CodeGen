...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSet___Should_implement_IDeepCloneable_of_ModelCloningPrivateSet___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSet);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSet>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSet>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSet___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSet);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSet>();

                // Act
                var actual = (ModelCloningPrivateSet)systemUnderTest.Clone();
