...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelCloningPrivateSetParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void MyModelCloningPrivateSetParent___Should_implement_IDeepCloneable_of_MyModelCloningPrivateSetParent___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPrivateSetParent);

                var expectedModelMethods = typeof(IDeepCloneable<MyModelCloningPrivateSetParent>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<MyModelCloningPrivateSetParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelCloningPrivateSetParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPrivateSetParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelCloningPrivateSetParent>();

                // Act
                var actual = (MyModelCloningPrivateSetParent)systemUnderTest.Clone();
