...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetChild2Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetChild2___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetChild2);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetChild2>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetChild2);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetChild2>();

                // Act
                var actual = (ModelCloningPrivateSetChild2)systemUnderTest.Clone();
