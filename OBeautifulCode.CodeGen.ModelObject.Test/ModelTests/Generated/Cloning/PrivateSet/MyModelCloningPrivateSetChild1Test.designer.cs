...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelCloningPrivateSetChild1Test
    {
        ...
        public static class Structural
        {
            ...
            public static void MyModelCloningPrivateSetChild1___Should_implement_IDeepCloneable_of_MyModelCloningPrivateSetChild1___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPrivateSetChild1);

                var expectedModelMethods = typeof(IDeepCloneable<MyModelCloningPrivateSetChild1>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<MyModelCloningPrivateSetChild1>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelCloningPrivateSetChild1___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPrivateSetChild1);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelCloningPrivateSetChild1>();

                // Act
                var actual = (MyModelCloningPrivateSetChild1)systemUnderTest.Clone();
