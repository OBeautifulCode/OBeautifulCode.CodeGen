...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetChild1Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetChild1___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetChild1___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetChild1);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetChild1>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetChild1>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetChild1___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetChild1);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetChild1>();

                // Act
                var actual = (ModelCloningPrivateSetChild1)systemUnderTest.Clone();
