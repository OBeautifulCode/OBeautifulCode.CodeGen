...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetReadOnlyCollectionParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSetReadOnlyCollectionParent___Should_implement_IDeepCloneable_of_ModelCloningPublicSetReadOnlyCollectionParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetReadOnlyCollectionParent);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetReadOnlyCollectionParent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetReadOnlyCollectionParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetReadOnlyCollectionParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetReadOnlyCollectionParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetReadOnlyCollectionParent>();

                // Act
                var actual = (ModelCloningPublicSetReadOnlyCollectionParent)systemUnderTest.Clone();
