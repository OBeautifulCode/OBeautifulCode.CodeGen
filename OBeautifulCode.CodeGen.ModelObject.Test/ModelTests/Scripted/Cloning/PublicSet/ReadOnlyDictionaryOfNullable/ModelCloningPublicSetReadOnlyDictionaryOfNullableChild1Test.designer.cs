...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1Test
    {
        ...
        public static class StructuralTesting
        {
            ...
            public static void ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1___Should_implement_IDeepCloneable_of_ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1>();

                // Act
                var actual = (ModelCloningPublicSetReadOnlyDictionaryOfNullableChild1)systemUnderTest.Clone();
