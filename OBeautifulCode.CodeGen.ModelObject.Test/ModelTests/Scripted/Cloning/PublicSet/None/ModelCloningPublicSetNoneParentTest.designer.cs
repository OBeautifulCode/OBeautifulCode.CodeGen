...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetNoneParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSetNoneParent___Should_implement_IDeepCloneable_of_ModelCloningPublicSetNoneParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetNoneParent);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetNoneParent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetNoneParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetNoneParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetNoneParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetNoneParent>();

                // Act
                var actual = (ModelCloningPublicSetNoneParent)systemUnderTest.Clone();
