...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetNoneChild2Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSetNoneChild2___Should_implement_IDeepCloneable_of_ModelCloningPublicSetNoneChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetNoneChild2);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetNoneChild2>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetNoneChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetNoneChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetNoneChild2);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetNoneChild2>();

                // Act
                var actual = (ModelCloningPublicSetNoneChild2)systemUnderTest.Clone();
