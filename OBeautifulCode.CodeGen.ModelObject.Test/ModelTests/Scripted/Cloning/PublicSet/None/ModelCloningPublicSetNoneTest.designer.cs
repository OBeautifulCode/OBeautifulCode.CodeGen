...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetNoneTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSetNone___Should_implement_IDeepCloneable_of_ModelCloningPublicSetNone___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetNone);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetNone>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetNone>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetNone___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetNone);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetNone>();

                // Act
                var actual = (ModelCloningPublicSetNone)systemUnderTest.Clone();
