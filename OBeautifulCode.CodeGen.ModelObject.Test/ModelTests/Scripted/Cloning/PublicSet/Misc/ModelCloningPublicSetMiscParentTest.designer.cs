...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetMiscParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSetMiscParent___Should_implement_IDeepCloneable_of_ModelCloningPublicSetMiscParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetMiscParent);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetMiscParent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetMiscParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetMiscParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetMiscParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetMiscParent>();

                // Act
                var actual = (ModelCloningPublicSetMiscParent)systemUnderTest.Clone();
