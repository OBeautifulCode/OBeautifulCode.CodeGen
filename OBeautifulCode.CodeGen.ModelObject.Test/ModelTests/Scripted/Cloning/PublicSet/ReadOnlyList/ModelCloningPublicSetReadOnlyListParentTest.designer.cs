...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPublicSetReadOnlyListParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPublicSetReadOnlyListParent___Should_implement_IDeepCloneable_of_ModelCloningPublicSetReadOnlyListParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetReadOnlyListParent);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPublicSetReadOnlyListParent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPublicSetReadOnlyListParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPublicSetReadOnlyListParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPublicSetReadOnlyListParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPublicSetReadOnlyListParent>();

                // Act
                var actual = (ModelCloningPublicSetReadOnlyListParent)systemUnderTest.Clone();
