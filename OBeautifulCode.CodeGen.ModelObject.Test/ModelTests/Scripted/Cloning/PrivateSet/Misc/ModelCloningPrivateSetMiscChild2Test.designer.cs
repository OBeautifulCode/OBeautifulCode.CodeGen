...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetMiscChild2Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetMiscChild2___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetMiscChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetMiscChild2);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetMiscChild2>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetMiscChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetMiscChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetMiscChild2);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetMiscChild2>();

                // Act
                var actual = (ModelCloningPrivateSetMiscChild2)systemUnderTest.Clone();
