...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetReadOnlyListOfNullableChild2Test
    {
        ...
        public static class StructuralTesting
        {
            ...
            public static void ModelCloningPrivateSetReadOnlyListOfNullableChild2___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetReadOnlyListOfNullableChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetReadOnlyListOfNullableChild2);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetReadOnlyListOfNullableChild2>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetReadOnlyListOfNullableChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetReadOnlyListOfNullableChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetReadOnlyListOfNullableChild2);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetReadOnlyListOfNullableChild2>();

                // Act
                var actual = (ModelCloningPrivateSetReadOnlyListOfNullableChild2)systemUnderTest.Clone();
