...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetNoneTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetNone___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetNone___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetNone);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetNone>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetNone>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetNone___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetNone);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetNone>();

                // Act
                var actual = (ModelCloningPrivateSetNone)systemUnderTest.Clone();
