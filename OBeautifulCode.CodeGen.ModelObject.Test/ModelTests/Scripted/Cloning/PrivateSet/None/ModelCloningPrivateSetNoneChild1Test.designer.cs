...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetNoneChild1Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetNoneChild1___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetNoneChild1___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetNoneChild1);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetNoneChild1>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetNoneChild1>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetNoneChild1___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetNoneChild1);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetNoneChild1>();

                // Act
                var actual = (ModelCloningPrivateSetNoneChild1)systemUnderTest.Clone();
