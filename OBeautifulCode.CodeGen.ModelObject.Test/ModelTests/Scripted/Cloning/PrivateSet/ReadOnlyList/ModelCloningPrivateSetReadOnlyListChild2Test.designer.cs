...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetReadOnlyListChild2Test
    {
        ...
        public static class StructuralTesting
        {
            ...
            public static void ModelCloningPrivateSetReadOnlyListChild2___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetReadOnlyListChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetReadOnlyListChild2);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetReadOnlyListChild2>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetReadOnlyListChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetReadOnlyListChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetReadOnlyListChild2);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetReadOnlyListChild2>();

                // Act
                var actual = (ModelCloningPrivateSetReadOnlyListChild2)systemUnderTest.Clone();
