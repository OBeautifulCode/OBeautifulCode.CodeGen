...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetArrayOfNullableChild1Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetArrayOfNullableChild1___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetArrayOfNullableChild1___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetArrayOfNullableChild1);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetArrayOfNullableChild1>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetArrayOfNullableChild1>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetArrayOfNullableChild1___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetArrayOfNullableChild1);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetArrayOfNullableChild1>();

                // Act
                var actual = (ModelCloningPrivateSetArrayOfNullableChild1)systemUnderTest.Clone();
