...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetArrayOfNullableChild2Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetArrayOfNullableChild2___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetArrayOfNullableChild2___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetArrayOfNullableChild2);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetArrayOfNullableChild2>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetArrayOfNullableChild2>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetArrayOfNullableChild2___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetArrayOfNullableChild2);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetArrayOfNullableChild2>();

                // Act
                var actual = (ModelCloningPrivateSetArrayOfNullableChild2)systemUnderTest.Clone();
