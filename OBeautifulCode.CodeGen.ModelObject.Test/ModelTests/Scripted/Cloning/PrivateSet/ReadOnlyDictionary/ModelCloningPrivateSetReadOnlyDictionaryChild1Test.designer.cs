...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetReadOnlyDictionaryChild1Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetReadOnlyDictionaryChild1___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetReadOnlyDictionaryChild1___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetReadOnlyDictionaryChild1);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetReadOnlyDictionaryChild1>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetReadOnlyDictionaryChild1>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetReadOnlyDictionaryChild1___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetReadOnlyDictionaryChild1);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetReadOnlyDictionaryChild1>();

                // Act
                var actual = (ModelCloningPrivateSetReadOnlyDictionaryChild1)systemUnderTest.Clone();
