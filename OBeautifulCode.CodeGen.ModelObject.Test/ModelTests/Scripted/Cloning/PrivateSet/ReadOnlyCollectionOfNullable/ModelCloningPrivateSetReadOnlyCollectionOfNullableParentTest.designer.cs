...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetReadOnlyCollectionOfNullableParentTest
    {
        ...
        public static class StructuralTesting
        {
            ...
            public static void ModelCloningPrivateSetReadOnlyCollectionOfNullableParent___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetReadOnlyCollectionOfNullableParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetReadOnlyCollectionOfNullableParent);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetReadOnlyCollectionOfNullableParent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetReadOnlyCollectionOfNullableParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetReadOnlyCollectionOfNullableParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetReadOnlyCollectionOfNullableParent);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetReadOnlyCollectionOfNullableParent>();

                // Act
                var actual = (ModelCloningPrivateSetReadOnlyCollectionOfNullableParent)systemUnderTest.Clone();
