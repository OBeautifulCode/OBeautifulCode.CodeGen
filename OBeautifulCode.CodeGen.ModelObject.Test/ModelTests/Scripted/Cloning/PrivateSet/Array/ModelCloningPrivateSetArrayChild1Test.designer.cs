...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelCloningPrivateSetArrayChild1Test
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelCloningPrivateSetArrayChild1___Should_implement_IDeepCloneable_of_ModelCloningPrivateSetArrayChild1___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetArrayChild1);

                var expectedModelMethods = typeof(IDeepCloneable<ModelCloningPrivateSetArrayChild1>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<ModelCloningPrivateSetArrayChild1>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelCloningPrivateSetArrayChild1___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelCloningPrivateSetArrayChild1);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelCloningPrivateSetArrayChild1>();

                // Act
                var actual = (ModelCloningPrivateSetArrayChild1)systemUnderTest.Clone();
