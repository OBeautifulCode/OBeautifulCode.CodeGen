...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelValidationPublicSetNullableTest
    {
        private static readonly ValidModelTestScenarios<ModelValidationPublicSetNullable> ValidModelTestScenarios = new ValidModelTestScenarios<ModelValidationPublicSetNullable>()
            .AddScenario(() =>
                new ValidModelTestScenario<ModelValidationPublicSetNullable>
                {
                    Name = "a dummy ModelValidationPublicSetNullable should be valid",
        ...
        public static class Structural
        {
            ...
            public static void ModelValidationPublicSetNullable___Should_implement_IValidatable___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelValidationPublicSetNullable);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelValidationPublicSetNullable___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelValidationPublicSetNullable);
