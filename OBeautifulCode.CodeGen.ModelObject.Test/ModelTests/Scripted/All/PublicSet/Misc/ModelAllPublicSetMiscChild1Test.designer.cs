...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelAllPublicSetMiscChild1Test
    {
        ...
        private static readonly ValidModelTestScenarios<ModelAllPublicSetMiscChild1> ValidModelTestScenarios = new ValidModelTestScenarios<ModelAllPublicSetMiscChild1>()
            .AddScenario(() =>
                new ValidModelTestScenario<ModelAllPublicSetMiscChild1>
                {
                    Name = "a dummy ModelAllPublicSetMiscChild1 should be valid",
                    SystemUnderTest = A.Dummy<ModelAllPublicSetMiscChild1>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(ModelAllPublicSetMiscChild1).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
