...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelAllPrivateSetMiscChild2Test
    {
        ...
        private static readonly ValidModelTestScenarios<ModelAllPrivateSetMiscChild2> ValidModelTestScenarios = new ValidModelTestScenarios<ModelAllPrivateSetMiscChild2>()
            .AddScenario(() =>
                new ValidModelTestScenario<ModelAllPrivateSetMiscChild2>
                {
                    Name = "a dummy ModelAllPrivateSetMiscChild2 should be valid",
                    SystemUnderTest = A.Dummy<ModelAllPrivateSetMiscChild2>(),
                });
