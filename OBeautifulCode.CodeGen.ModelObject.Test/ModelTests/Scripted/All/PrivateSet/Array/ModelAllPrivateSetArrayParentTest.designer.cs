...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelAllPrivateSetArrayParentTest
    {
        private static readonly ModelAllPrivateSetArrayParent ReferenceObjectForEquatableTestScenarios = A.Dummy<ModelAllPrivateSetArrayParent>();

        private static readonly EquatableTestScenarios<ModelAllPrivateSetArrayParent> EquatableTestScenarios = new EquatableTestScenarios<ModelAllPrivateSetArrayParent>()
            .AddScenario(() =>
                new EquatableTestScenario<ModelAllPrivateSetArrayParent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ModelAllPrivateSetArrayParent[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ModelAllPrivateSetArrayParent[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfBoolProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfBoolProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfBoolProperty)).ParentArrayOfBoolProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfIntProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfIntProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfIntProperty)).ParentArrayOfIntProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfStringProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfStringProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfStringProperty)).ParentArrayOfStringProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfGuidProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfGuidProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfGuidProperty)).ParentArrayOfGuidProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfDateTimeProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfDateTimeProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfDateTimeProperty)).ParentArrayOfDateTimeProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfCustomEnumProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfCustomEnumProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfCustomEnumProperty)).ParentArrayOfCustomEnumProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfCustomEnumValidatedNotDefaultProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfCustomEnumValidatedNotDefaultProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfCustomEnumValidatedNotDefaultProperty)).ParentArrayOfCustomEnumValidatedNotDefaultProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfCustomFlagsEnumProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfCustomFlagsEnumProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfCustomFlagsEnumProperty)).ParentArrayOfCustomFlagsEnumProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfCustomClassProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfCustomClassProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfCustomClassProperty)).ParentArrayOfCustomClassProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfCustomBaseClassProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfCustomBaseClassProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfCustomBaseClassProperty)).ParentArrayOfCustomBaseClassProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayOfCustomGenericClassOfCustomClassProperty(A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => !_.ParentArrayOfCustomGenericClassOfCustomClassProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayOfCustomGenericClassOfCustomClassProperty)).ParentArrayOfCustomGenericClassOfCustomClassProperty),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new ModelAllPrivateSetArrayParent[]
                    {
                        A.Dummy<ModelAllPrivateSetArrayParent>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            public static void ModelAllPrivateSetArrayParent___Should_implement_IModel_of_ModelAllPrivateSetArrayParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelAllPrivateSetArrayParent);

                var expectedModelMethods = typeof(IModel<ModelAllPrivateSetArrayParent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ModelAllPrivateSetArrayParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelAllPrivateSetArrayParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelAllPrivateSetArrayParent);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelAllPrivateSetArrayParent>();

                // Act
                var actual = (ModelAllPrivateSetArrayParent)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ModelAllPrivateSetArrayParent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ModelAllPrivateSetArrayParent systemUnderTest1 = null;
                ModelAllPrivateSetArrayParent systemUnderTest2 = null;
