...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelCloningPublicSettersParentTest
    {
        ...
        public static class Structural
        {
            ...
            public static void MyModelCloningPublicSettersParent___Should_implement_IDeepCloneable_of_MyModelCloningPublicSettersParent___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPublicSettersParent);

                var expectedModelMethods = typeof(IDeepCloneable<MyModelCloningPublicSettersParent>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IDeepCloneable<MyModelCloningPublicSettersParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelCloningPublicSettersParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelCloningPublicSettersParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelCloningPublicSettersParent>();

                // Act
                var actual = (MyModelCloningPublicSettersParent)systemUnderTest.Clone();
