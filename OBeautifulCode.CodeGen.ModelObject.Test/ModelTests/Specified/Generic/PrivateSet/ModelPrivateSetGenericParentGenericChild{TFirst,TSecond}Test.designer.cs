...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelPrivateSetGenericParentGenericChildTFirstTSecondTest
    {
        ...
        public static class Structural
        {
            ...
            public static void ModelPrivateSetGenericParentGenericChild_of_Version_Guid___Should_implement_IModel_of_ModelPrivateSetGenericParentGenericChild_of_Version_Guid___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelPrivateSetGenericParentGenericChild<Version, Guid>);

                var expectedModelMethods = typeof(IModel<ModelPrivateSetGenericParentGenericChild<Version, Guid>>).GetInterfaceDeclaredAndImplementedMethods();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelPrivateSetGenericParentGenericChild_of_Version_Guid___Should_implement_IComparableForRelativeSortOrder_of_ModelPrivateSetGenericParentGenericChild_of_Version_Guid___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelPrivateSetGenericParentGenericChild<Version, Guid>);

                var expectedModelMethods = typeof(IComparableForRelativeSortOrder<ModelPrivateSetGenericParentGenericChild<Version, Guid>>).GetInterfaceDeclaredAndImplementedMethods();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelPrivateSetGenericParentGenericChild_of_Version_Guid___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelPrivateSetGenericParentGenericChild<Version, Guid>);
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(ModelPrivateSetGenericParentGenericChild<Version, Guid>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
