...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelPrivateSetNonGenericParentTest
    {
        private static readonly ModelPrivateSetNonGenericParent ReferenceObjectForEquatableTestScenarios = A.Dummy<ModelPrivateSetNonGenericParent>();

        private static readonly EquatableTestScenarios<ModelPrivateSetNonGenericParent> EquatableTestScenarios = new EquatableTestScenarios<ModelPrivateSetNonGenericParent>()
            .AddScenario(() =>
                new EquatableTestScenario<ModelPrivateSetNonGenericParent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ModelPrivateSetNonGenericParent[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ModelPrivateSetNonGenericParent[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentStringProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentStringProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentStringProperty)).ParentStringProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentIntProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentIntProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentIntProperty)).ParentIntProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentEnumProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentEnumProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentEnumProperty)).ParentEnumProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentCustomClassProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentCustomClassProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentCustomClassProperty)).ParentCustomClassProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentArrayProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentArrayProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentArrayProperty)).ParentArrayProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentNullableProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentNullableProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentNullableProperty)).ParentNullableProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentCustomGenericClassProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentCustomGenericClassProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentCustomGenericClassProperty)).ParentCustomGenericClassProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentReadOnlyCollectionProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentReadOnlyCollectionProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentReadOnlyCollectionProperty)).ParentReadOnlyCollectionProperty),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentReadOnlyDictionaryProperty(A.Dummy<ModelPrivateSetNonGenericParent>().Whose(_ => !_.ParentReadOnlyDictionaryProperty.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentReadOnlyDictionaryProperty)).ParentReadOnlyDictionaryProperty),
                    },
        ...
        private static readonly ComparableTestScenarios<ModelPrivateSetNonGenericParent> ComparableTestScenarios = new ComparableTestScenarios<ModelPrivateSetNonGenericParent>();
        ...
        public static class StructuralTesting
        {
            ...
            public static void ModelPrivateSetNonGenericParent___Should_implement_IModel_of_ModelPrivateSetNonGenericParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelPrivateSetNonGenericParent);

                var expectedModelMethods = typeof(IModel<ModelPrivateSetNonGenericParent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ModelPrivateSetNonGenericParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelPrivateSetNonGenericParent___Should_implement_IComparableForRelativeSortOrder_of_ModelPrivateSetNonGenericParent___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelPrivateSetNonGenericParent);

                var expectedModelMethods = typeof(IComparableForRelativeSortOrder<ModelPrivateSetNonGenericParent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IComparableForRelativeSortOrder<ModelPrivateSetNonGenericParent>));
                expectedModelMethodHashes.Except(actualModelMethodHashes).AsTest().Must().BeEmptyEnumerable();
            }
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelPrivateSetNonGenericParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelPrivateSetNonGenericParent);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ModelPrivateSetNonGenericParent>();

                // Act
                var actual = (ModelPrivateSetNonGenericParent)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ModelPrivateSetNonGenericParent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ModelPrivateSetNonGenericParent systemUnderTest1 = null;
                ModelPrivateSetNonGenericParent systemUnderTest2 = null;
