...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelPrivateSetExpressionBodyChild1Test
    {
        ...
        private static readonly ValidModelTestScenarios<ModelPrivateSetExpressionBodyChild1> ValidModelTestScenarios = new ValidModelTestScenarios<ModelPrivateSetExpressionBodyChild1>()
            .AddScenario(() =>
                new ValidModelTestScenario<ModelPrivateSetExpressionBodyChild1>
                {
                    Name = "a dummy ModelPrivateSetExpressionBodyChild1 should be valid",
                    SystemUnderTest = A.Dummy<ModelPrivateSetExpressionBodyChild1>(),
                });
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(ModelPrivateSetExpressionBodyChild1).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
