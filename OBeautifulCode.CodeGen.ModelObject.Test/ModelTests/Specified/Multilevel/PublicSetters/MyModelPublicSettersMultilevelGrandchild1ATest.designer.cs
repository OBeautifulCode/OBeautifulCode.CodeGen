...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelPublicSettersMultilevelGrandchild1ATest
    {
                ...
                new StringRepresentationTestScenario<MyModelPublicSettersMultilevelGrandchild1A>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<MyModelPublicSettersMultilevelGrandchild1A>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.CodeGen.ModelObject.Test.MyModelPublicSettersMultilevelGrandchild1A: ParentInt = {systemUnderTest.ParentInt.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Child1Int = {systemUnderTest.Child1Int.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Grandchild1AInt = {systemUnderTest.Grandchild1AInt.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<MyModelPublicSettersMultilevelGrandchild1A> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MyModelPublicSettersMultilevelGrandchild1A>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MyModelPublicSettersMultilevelGrandchild1A>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MyModelPublicSettersMultilevelGrandchild1A>().ThatIs(_ => !systemUnderTest.ParentInt.IsEqualTo(_.ParentInt));

                        var result = new SystemUnderTestDeepCloneWithValue<MyModelPublicSettersMultilevelGrandchild1A>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MyModelPublicSettersMultilevelGrandchild1A>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MyModelPublicSettersMultilevelGrandchild1A>().ThatIs(_ => !systemUnderTest.Child1Int.IsEqualTo(_.Child1Int));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MyModelPublicSettersMultilevelGrandchild1A>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MyModelPublicSettersMultilevelGrandchild1A>().ThatIs(_ => !systemUnderTest.Grandchild1AInt.IsEqualTo(_.Grandchild1AInt));
            ...
            .AddScenario(() =>
                new EquatableTestScenario<MyModelPublicSettersMultilevelGrandchild1A>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new MyModelPublicSettersMultilevelGrandchild1A[]
                    {
                        new MyModelPublicSettersMultilevelGrandchild1A
                            {
                                ParentInt       = A.Dummy<MyModelPublicSettersMultilevelGrandchild1A>().Whose(_ => !_.ParentInt.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentInt)).ParentInt,
                                Child1Int       = ReferenceObjectForEquatableTestScenarios.Child1Int,
                                Grandchild1AInt = ReferenceObjectForEquatableTestScenarios.Grandchild1AInt,
                            },
                        new MyModelPublicSettersMultilevelGrandchild1A
                            {
                                ParentInt       = ReferenceObjectForEquatableTestScenarios.ParentInt,
                                Child1Int       = A.Dummy<MyModelPublicSettersMultilevelGrandchild1A>().Whose(_ => !_.Child1Int.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Child1Int)).Child1Int,
                                Grandchild1AInt = ReferenceObjectForEquatableTestScenarios.Grandchild1AInt,
                            },
                        new MyModelPublicSettersMultilevelGrandchild1A
                            {
                                ParentInt       = ReferenceObjectForEquatableTestScenarios.ParentInt,
                                Child1Int       = ReferenceObjectForEquatableTestScenarios.Child1Int,
                                Grandchild1AInt = A.Dummy<MyModelPublicSettersMultilevelGrandchild1A>().Whose(_ => !_.Grandchild1AInt.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Grandchild1AInt)).Grandchild1AInt,
                            },
                    },
        ...
        public static class Structural
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelPublicSettersMultilevelGrandchild1A___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPublicSettersMultilevelGrandchild1A);
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (MyModelPublicSettersMultilevelGrandchild1A)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(MyModelPublicSettersMultilevelGrandchild1A).GetProperty(propertyName);
