...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelPublicSetMultilevelParentTest
    {
        ...
        private static readonly MyModelPublicSetMultilevelParent ReferenceObjectForEquatableTestScenarios = A.Dummy<MyModelPublicSetMultilevelParent>();

        private static readonly EquatableTestScenarios<MyModelPublicSetMultilevelParent> EquatableTestScenarios = new EquatableTestScenarios<MyModelPublicSetMultilevelParent>()
            .AddScenario(() =>
                new EquatableTestScenario<MyModelPublicSetMultilevelParent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new MyModelPublicSetMultilevelParent[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new MyModelPublicSetMultilevelParent[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentInt(A.Dummy<MyModelPublicSetMultilevelParent>().Whose(_ => !_.ParentInt.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentInt)).ParentInt),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new MyModelPublicSetMultilevelParent[]
                    {
                        A.Dummy<MyModelPublicSetMultilevelParent>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        private static readonly ComparableTestScenarios<MyModelPublicSetMultilevelParent> ComparableTestScenarios = new ComparableTestScenarios<MyModelPublicSetMultilevelParent>();
        ...
        public static class Structural
        {
            ...
            public static void MyModelPublicSetMultilevelParent___Should_implement_IModel_of_MyModelPublicSetMultilevelParent___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPublicSetMultilevelParent);

                var expectedModelMethods = typeof(IModel<MyModelPublicSetMultilevelParent>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<MyModelPublicSetMultilevelParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelPublicSetMultilevelParent___Should_implement_IComparableForRelativeSortOrder_of_MyModelPublicSetMultilevelParent___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPublicSetMultilevelParent);

                var expectedModelMethods = typeof(IComparableForRelativeSortOrder<MyModelPublicSetMultilevelParent>)
                                          .GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.FlattenHierarchy)
                                          .ToList();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IComparableForRelativeSortOrder<MyModelPublicSetMultilevelParent>));
                expectedModelMethodHashes.Except(actualModelMethodHashes).AsTest().Must().BeEmptyEnumerable();
            }
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelPublicSetMultilevelParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPublicSetMultilevelParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelPublicSetMultilevelParent>();

                // Act
                var actual = (MyModelPublicSetMultilevelParent)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<MyModelPublicSetMultilevelParent>();
                ...
                // Act
                var actual = serializer.Deserialize<MyModelPublicSetMultilevelParent>(serializedBson);
            ...
            public static void Deserialize___Should_roundtrip_object___When_serializing_to_and_deserializing_from_string_using_ObcJsonSerializer()
            {
                ...
                // Act
                var actual = serializer.Deserialize<MyModelPublicSetMultilevelParent>(serializedJson);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                MyModelPublicSetMultilevelParent systemUnderTest1 = null;
                MyModelPublicSetMultilevelParent systemUnderTest2 = null;
