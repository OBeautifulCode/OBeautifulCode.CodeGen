...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class MyModelPrivateSetMultilevelParentTest
    {
        ...
        private static readonly MyModelPrivateSetMultilevelParent ReferenceObjectForEquatableTestScenarios = A.Dummy<MyModelPrivateSetMultilevelParent>();

        private static readonly EquatableTestScenarios<MyModelPrivateSetMultilevelParent> EquatableTestScenarios = new EquatableTestScenarios<MyModelPrivateSetMultilevelParent>()
            .AddScenario(() =>
                new EquatableTestScenario<MyModelPrivateSetMultilevelParent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new MyModelPrivateSetMultilevelParent[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new MyModelPrivateSetMultilevelParent[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithParentInt(A.Dummy<MyModelPrivateSetMultilevelParent>().Whose(_ => !_.ParentInt.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParentInt)).ParentInt),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new MyModelPrivateSetMultilevelParent[]
                    {
                        A.Dummy<MyModelPrivateSetMultilevelParent>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        private static readonly ComparableTestScenarios<MyModelPrivateSetMultilevelParent> ComparableTestScenarios = new ComparableTestScenarios<MyModelPrivateSetMultilevelParent>();
        ...
        public static class Structural
        {
            ...
            public static void MyModelPrivateSetMultilevelParent___Should_implement_IModel_of_MyModelPrivateSetMultilevelParent___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPrivateSetMultilevelParent);

                var expectedModelMethods = typeof(IModel<MyModelPrivateSetMultilevelParent>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<MyModelPrivateSetMultilevelParent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelPrivateSetMultilevelParent___Should_implement_IComparableForRelativeSortOrder_of_MyModelPrivateSetMultilevelParent___When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPrivateSetMultilevelParent);

                var expectedModelMethods = typeof(IComparableForRelativeSortOrder<MyModelPrivateSetMultilevelParent>)
                                          .GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.FlattenHierarchy)
                                          .ToList();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IComparableForRelativeSortOrder<MyModelPrivateSetMultilevelParent>));
                expectedModelMethodHashes.Except(actualModelMethodHashes).AsTest().Must().BeEmptyEnumerable();
            }
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MyModelPrivateSetMultilevelParent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MyModelPrivateSetMultilevelParent);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MyModelPrivateSetMultilevelParent>();

                // Act
                var actual = (MyModelPrivateSetMultilevelParent)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<MyModelPrivateSetMultilevelParent>();
                ...
                // Act
                var actual = serializer.Deserialize<MyModelPrivateSetMultilevelParent>(serializedBson);
            ...
            public static void Deserialize___Should_roundtrip_object___When_serializing_to_and_deserializing_from_string_using_ObcJsonSerializer()
            {
                ...
                // Act
                var actual = serializer.Deserialize<MyModelPrivateSetMultilevelParent>(serializedJson);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                MyModelPrivateSetMultilevelParent systemUnderTest1 = null;
                MyModelPrivateSetMultilevelParent systemUnderTest2 = null;
