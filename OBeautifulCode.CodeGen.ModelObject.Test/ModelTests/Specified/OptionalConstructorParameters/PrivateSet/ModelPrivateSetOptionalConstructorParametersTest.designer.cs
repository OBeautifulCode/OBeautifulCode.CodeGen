...
namespace OBeautifulCode.CodeGen.ModelObject.Test.Test
{
    ...
    public static partial class ModelPrivateSetOptionalConstructorParametersTest
    {
        private static readonly StringRepresentationTestScenarios<ModelPrivateSetOptionalConstructorParameters> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ModelPrivateSetOptionalConstructorParameters>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ModelPrivateSetOptionalConstructorParameters> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ModelPrivateSetOptionalConstructorParameters>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'item3' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "item3", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
                    Name = "constructor should throw ArgumentException when parameter 'item3' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ModelPrivateSetOptionalConstructorParameters>();
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ModelPrivateSetOptionalConstructorParameters>().ThatIs(_ => !systemUnderTest.Item1.IsEqualTo(_.Item1));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ModelPrivateSetOptionalConstructorParameters>().ThatIs(_ => !systemUnderTest.Item2.IsEqualTo(_.Item2));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ModelPrivateSetOptionalConstructorParameters>().ThatIs(_ => !systemUnderTest.Item3.IsEqualTo(_.Item3));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ModelPrivateSetOptionalConstructorParameters>().ThatIs(_ => !systemUnderTest.Item4.IsEqualTo(_.Item4));
        ...
        private static readonly EquatableTestScenarios<ModelPrivateSetOptionalConstructorParameters> EquatableTestScenarios = new EquatableTestScenarios<ModelPrivateSetOptionalConstructorParameters>()
            .AddScenario(() =>
                new EquatableTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ModelPrivateSetOptionalConstructorParameters[]
                    {
        ...
        private static readonly ValidModelTestScenarios<ModelPrivateSetOptionalConstructorParameters> ValidModelTestScenarios = new ValidModelTestScenarios<ModelPrivateSetOptionalConstructorParameters>()
            .AddScenario(() =>
                new ValidModelTestScenario<ModelPrivateSetOptionalConstructorParameters>
                {
                    Name = "a dummy ModelPrivateSetOptionalConstructorParameters should be valid",
                    SystemUnderTest = A.Dummy<ModelPrivateSetOptionalConstructorParameters>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void ModelPrivateSetOptionalConstructorParameters___Should_implement_IModel_of_ModelPrivateSetOptionalConstructorParameters___When_reflecting()
            {
                // Arrange
                var type = typeof(ModelPrivateSetOptionalConstructorParameters);

                var expectedModelMethods = typeof(IModel<ModelPrivateSetOptionalConstructorParameters>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ModelPrivateSetOptionalConstructorParameters>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ModelPrivateSetOptionalConstructorParameters___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ModelPrivateSetOptionalConstructorParameters);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ModelPrivateSetOptionalConstructorParameters)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Item4 == null)
                {
                    actual.Item4.AsTest().Must().BeNull();
                }
                else if (!actual.Item4.GetType().IsValueType)
                {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ModelPrivateSetOptionalConstructorParameters)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ModelPrivateSetOptionalConstructorParameters).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ModelPrivateSetOptionalConstructorParameters>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ModelPrivateSetOptionalConstructorParameters systemUnderTest1 = null;
                ModelPrivateSetOptionalConstructorParameters systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ModelPrivateSetOptionalConstructorParameters systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ModelPrivateSetOptionalConstructorParameters___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ModelPrivateSetOptionalConstructorParameters___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ModelPrivateSetOptionalConstructorParameters___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ModelPrivateSetOptionalConstructorParameters___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ModelPrivateSetOptionalConstructorParameters___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
