            ...
            var result = new ModelAllPublicSetMiscChild1
                             {
                                 ...
                                 Child1CollectionInterfaceOfStringProperty                                                                                    = this.Child1CollectionInterfaceOfStringProperty?.Select(i => i?.Clone().ToString()).ToList(),
                                 Child1ListInterfaceOfStringProperty                                                                                          = this.Child1ListInterfaceOfStringProperty?.Select(i => i?.Clone().ToString()).ToList(),
                                 Child1ReadOnlyCollectionInterfaceOfCollectionInterfaceOfStringProperty                                                       = this.Child1ReadOnlyCollectionInterfaceOfCollectionInterfaceOfStringProperty?.Select(i => (ICollection<string>)i?.Select(i2 => i2?.Clone().ToString()).ToList()).ToList(),
                                 Child1CollectionInterfaceOfReadOnlyListInterfaceOfStringProperty                                                             = this.Child1CollectionInterfaceOfReadOnlyListInterfaceOfStringProperty?.Select(i => (IReadOnlyList<string>)i?.Select(i2 => i2?.Clone().ToString()).ToList()).ToList(),
                                 Child1ListInterfaceOfCollectionInterfaceOfStringProperty                                                                     = this.Child1ListInterfaceOfCollectionInterfaceOfStringProperty?.Select(i => (ICollection<string>)i?.Select(i2 => i2?.Clone().ToString()).ToList()).ToList(),
                                 Child1ReadOnlyListInterfaceOfListInterfaceOfStringProperty                                                                   = this.Child1ReadOnlyListInterfaceOfListInterfaceOfStringProperty?.Select(i => (IList<string>)i?.Select(i2 => i2?.Clone().ToString()).ToList()).ToList(),
                                 Child1DictionaryInterfaceOfReadOnlyListInterfaceOfDateTimeProperty                                                           = this.Child1DictionaryInterfaceOfReadOnlyListInterfaceOfDateTimeProperty?.ToDictionary(k => k.Key?.Clone().ToString(), v => (IReadOnlyList<DateTime>)v.Value?.Select(i2 => i2).ToList()),
                                 Child1ReadOnlyDictionaryInterfaceOfCollectionInterfaceOfDateTimeProperty                                                     = this.Child1ReadOnlyDictionaryInterfaceOfCollectionInterfaceOfDateTimeProperty?.ToDictionary(k => k.Key?.Clone().ToString(), v => (ICollection<DateTime>)v.Value?.Select(i2 => i2).ToList()),
