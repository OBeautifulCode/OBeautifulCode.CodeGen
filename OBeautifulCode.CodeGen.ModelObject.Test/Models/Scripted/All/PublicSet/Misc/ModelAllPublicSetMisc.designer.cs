    ...
    public partial class ModelAllPublicSetMisc : IModel<ModelAllPublicSetMisc>
    {
        ...
        public ModelAllPublicSetMisc DeepClone()
        {
            var result = new ModelAllPublicSetMisc
                             {
                                 CollectionInterfaceOfStringProperty                                                                                    = this.CollectionInterfaceOfStringProperty?.Select(i => i?.DeepClone()).ToList(),
                                 ListInterfaceOfStringProperty                                                                                          = this.ListInterfaceOfStringProperty?.Select(i => i?.DeepClone()).ToList(),
                                 ReadOnlyCollectionInterfaceOfCollectionInterfaceOfStringProperty                                                       = this.ReadOnlyCollectionInterfaceOfCollectionInterfaceOfStringProperty?.Select(i => (ICollection<string>)i?.Select(i2 => i2?.DeepClone()).ToList()).ToList(),
                                 CollectionInterfaceOfReadOnlyListInterfaceOfStringProperty                                                             = this.CollectionInterfaceOfReadOnlyListInterfaceOfStringProperty?.Select(i => (IReadOnlyList<string>)i?.Select(i2 => i2?.DeepClone()).ToList()).ToList(),
                                 ListInterfaceOfCollectionInterfaceOfStringProperty                                                                     = this.ListInterfaceOfCollectionInterfaceOfStringProperty?.Select(i => (ICollection<string>)i?.Select(i2 => i2?.DeepClone()).ToList()).ToList(),
                                 ReadOnlyListInterfaceOfListInterfaceOfStringProperty                                                                   = this.ReadOnlyListInterfaceOfListInterfaceOfStringProperty?.Select(i => (IList<string>)i?.Select(i2 => i2?.DeepClone()).ToList()).ToList(),
                                 DictionaryInterfaceOfReadOnlyListInterfaceOfDateTimeProperty                                                           = this.DictionaryInterfaceOfReadOnlyListInterfaceOfDateTimeProperty?.ToDictionary(k => k.Key?.DeepClone(), v => (IReadOnlyList<DateTime>)v.Value?.Select(i2 => i2).ToList()),
                                 ReadOnlyDictionaryInterfaceOfCollectionInterfaceOfDateTimeProperty                                                     = this.ReadOnlyDictionaryInterfaceOfCollectionInterfaceOfDateTimeProperty?.ToDictionary(k => k.Key?.DeepClone(), v => (ICollection<DateTime>)v.Value?.Select(i2 => i2).ToList()),
