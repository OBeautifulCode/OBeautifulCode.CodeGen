            ...
            var result = new ModelAllPublicSetMiscChild2
                             {
                                 ...
                                 Child2CollectionInterfaceOfStringProperty                                                                                    = this.Child2CollectionInterfaceOfStringProperty?.Select(i => i?.DeepClone()).ToList(),
                                 Child2ListInterfaceOfStringProperty                                                                                          = this.Child2ListInterfaceOfStringProperty?.Select(i => i?.DeepClone()).ToList(),
                                 Child2ReadOnlyCollectionInterfaceOfCollectionInterfaceOfStringProperty                                                       = this.Child2ReadOnlyCollectionInterfaceOfCollectionInterfaceOfStringProperty?.Select(i => (ICollection<string>)i?.Select(i2 => i2?.DeepClone()).ToList()).ToList(),
                                 Child2CollectionInterfaceOfReadOnlyListInterfaceOfStringProperty                                                             = this.Child2CollectionInterfaceOfReadOnlyListInterfaceOfStringProperty?.Select(i => (IReadOnlyList<string>)i?.Select(i2 => i2?.DeepClone()).ToList()).ToList(),
                                 Child2ListInterfaceOfCollectionInterfaceOfStringProperty                                                                     = this.Child2ListInterfaceOfCollectionInterfaceOfStringProperty?.Select(i => (ICollection<string>)i?.Select(i2 => i2?.DeepClone()).ToList()).ToList(),
                                 Child2ReadOnlyListInterfaceOfListInterfaceOfStringProperty                                                                   = this.Child2ReadOnlyListInterfaceOfListInterfaceOfStringProperty?.Select(i => (IList<string>)i?.Select(i2 => i2?.DeepClone()).ToList()).ToList(),
                                 Child2DictionaryInterfaceOfReadOnlyListInterfaceOfDateTimeProperty                                                           = this.Child2DictionaryInterfaceOfReadOnlyListInterfaceOfDateTimeProperty?.ToDictionary(k => k.Key?.DeepClone(), v => (IReadOnlyList<DateTime>)v.Value?.Select(i2 => i2).ToList()),
                                 Child2ReadOnlyDictionaryInterfaceOfCollectionInterfaceOfDateTimeProperty                                                     = this.Child2ReadOnlyDictionaryInterfaceOfCollectionInterfaceOfDateTimeProperty?.ToDictionary(k => k.Key?.DeepClone(), v => (ICollection<DateTime>)v.Value?.Select(i2 => i2).ToList()),
