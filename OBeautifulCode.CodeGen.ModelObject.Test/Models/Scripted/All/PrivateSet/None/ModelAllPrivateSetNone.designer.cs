    ...
    public partial class ModelAllPrivateSetNone : IModel<ModelAllPrivateSetNone>
    {
        ...
        public ModelAllPrivateSetNone DeepClone()
        {
            var result = new ModelAllPrivateSetNone(
                                 ...
                                 this.CustomEnumValidatedNotDefaultProperty.DeepClone(),
        ...
        /// <returns>New <see cref="ModelAllPrivateSetNone" /> using the specified <paramref name="customEnumValidatedNotDefaultProperty" /> for <see cref="CustomEnumValidatedNotDefaultProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelAllPrivateSetNone DeepCloneWithCustomEnumValidatedNotDefaultProperty(CustomEnumValidatedNotDefault customEnumValidatedNotDefaultProperty)
        {
            var result = new ModelAllPrivateSetNone(
                                 this.BoolProperty.DeepClone(),
                                 this.IntProperty.DeepClone(),
                                 ...
                                 this.DateTimeProperty.DeepClone(),
                                 this.CustomEnumProperty.DeepClone(),
                                 customEnumValidatedNotDefaultProperty,
                                 this.CustomFlagsEnumProperty.DeepClone(),
                                 this.CustomClassProperty?.DeepClone(),
                                 this.CustomBaseClassProperty?.DeepClone(),
                                 this.CustomGenericClassOfCustomClassProperty?.DeepClone());
