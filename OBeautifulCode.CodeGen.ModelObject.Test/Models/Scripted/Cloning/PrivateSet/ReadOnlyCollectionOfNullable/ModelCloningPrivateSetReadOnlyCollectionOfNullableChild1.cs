// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1.cs" company="OBeautifulCode">
...
#pragma warning disable CS0661
    ...
    public partial class ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1 : ModelCloningPrivateSetReadOnlyCollectionOfNullableParent, IDeepCloneableViaCodeGen, IDeclareDeepCloneMethod<ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1>, IEquatable<ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1>
#pragma warning disable CS0659
#pragma warning disable CS0661
    {
        ...
        public ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1(
        ...
        /// <inheritdoc />
        public bool Equals(ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1 other)
        {
        ...
        {
            var result = this.Equals((ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1)other);

            return result;
        }

        /// <inheritdoc />
        ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1 IDeclareDeepCloneMethod<ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1>.DeepClone()
        {
        ...
        private ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1 DeepCloneImplementation()
        {
            var referenceModel = A.Dummy<ModelAllPrivateSetReadOnlyCollectionOfNullableChild1>();
            ...
            referenceModel = (ModelAllPrivateSetReadOnlyCollectionOfNullableChild1)referenceModel.GetType().GetMethod("DeepClone").Invoke(referenceModel, new object[0]);

            var thisModelProperties = this.GetType().GetProperties();

            var result = A.Dummy<ModelCloningPrivateSetReadOnlyCollectionOfNullableChild1>();
