// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelCloningPublicSetMiscChild2.cs" company="OBeautifulCode">
...
#pragma warning disable CS0661
    ...
    public partial class ModelCloningPublicSetMiscChild2 : ModelCloningPublicSetMiscParent, IDeepCloneableViaCodeGen, IDeclareDeepCloneMethod<ModelCloningPublicSetMiscChild2>, IEquatable<ModelCloningPublicSetMiscChild2>
#pragma warning disable CS0659
#pragma warning disable CS0661
    {
        ...
        /// <inheritdoc />
        public bool Equals(ModelCloningPublicSetMiscChild2 other)
        {
        ...
        {
            var result = this.Equals((ModelCloningPublicSetMiscChild2)other);

            return result;
        }

        /// <inheritdoc />
        ModelCloningPublicSetMiscChild2 IDeclareDeepCloneMethod<ModelCloningPublicSetMiscChild2>.DeepClone()
        {
        ...
        private ModelCloningPublicSetMiscChild2 DeepCloneImplementation()
        {
            var referenceModel = A.Dummy<ModelAllPublicSetMiscChild2>();
            ...
            referenceModel = (ModelAllPublicSetMiscChild2)referenceModel.GetType().GetMethod("DeepClone").Invoke(referenceModel, new object[0]);

            var thisModelProperties = this.GetType().GetProperties();

            var result = A.Dummy<ModelCloningPublicSetMiscChild2>();
