// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelCloningPublicSetReadOnlyDictionaryChild1.cs" company="OBeautifulCode">
...
#pragma warning disable CS0661
    ...
    public partial class ModelCloningPublicSetReadOnlyDictionaryChild1 : ModelCloningPublicSetReadOnlyDictionaryParent, IDeepCloneableViaCodeGen, IDeclareDeepCloneMethod<ModelCloningPublicSetReadOnlyDictionaryChild1>, IEquatable<ModelCloningPublicSetReadOnlyDictionaryChild1>
#pragma warning disable CS0659
#pragma warning disable CS0661
    {
        ...
        /// <inheritdoc />
        public bool Equals(ModelCloningPublicSetReadOnlyDictionaryChild1 other)
        {
        ...
        {
            var result = this.Equals((ModelCloningPublicSetReadOnlyDictionaryChild1)other);

            return result;
        }

        /// <inheritdoc />
        ModelCloningPublicSetReadOnlyDictionaryChild1 IDeclareDeepCloneMethod<ModelCloningPublicSetReadOnlyDictionaryChild1>.DeepClone()
        {
        ...
        private ModelCloningPublicSetReadOnlyDictionaryChild1 DeepCloneImplementation()
        {
            var referenceModel = A.Dummy<ModelAllPublicSetReadOnlyDictionaryChild1>();
            ...
            referenceModel = (ModelAllPublicSetReadOnlyDictionaryChild1)referenceModel.GetType().GetMethod("DeepClone").Invoke(referenceModel, new object[0]);

            var thisModelProperties = this.GetType().GetProperties();

            var result = A.Dummy<ModelCloningPublicSetReadOnlyDictionaryChild1>();
