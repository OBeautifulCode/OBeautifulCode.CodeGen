// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelEqualityPrivateSetMisc.cs" company="OBeautifulCode">
...
#pragma warning disable CS0661
    ...
    public partial class ModelEqualityPrivateSetMisc : IEquatableViaCodeGen, IDeclareEqualsMethod<ModelEqualityPrivateSetMisc>
#pragma warning disable CS0659
#pragma warning disable CS0661
    {
        ...
        public ModelEqualityPrivateSetMisc(
        ...
        {
            new { collectionInterfaceOfStringProperty }.AsArg().Must().NotBeNullNorEmptyEnumerableNorContainAnyNulls().And().Each().NotBeNullNorWhiteSpace();
            new { listInterfaceOfStringProperty }.AsArg().Must().NotBeNullNorEmptyEnumerableNorContainAnyNulls().And().Each().NotBeNullNorWhiteSpace();
        ...
        /// <inheritdoc />
        public bool Equals(ModelEqualityPrivateSetMisc other)
        {
