// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelValidationPublicSetNoneChild2.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class ModelValidationPublicSetNoneChild2 : ModelValidationPublicSetNoneParent, IValidatableViaCodeGen, IDeclareGetSelfValidationFailuresMethod
    {
                ...
                .Concat(new[]
                    {
                        ...
                        new { this.Child2CustomEnumValidatedNotDefaultProperty }.ForRecording().Must().NotBeEqualTo(CustomEnumValidatedNotDefault.Unknown),
