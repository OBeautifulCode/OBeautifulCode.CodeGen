// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelValidationPublicSetNullableChild2.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class ModelValidationPublicSetNullableChild2 : ModelValidationPublicSetNullableParent, IValidatableViaCodeGen, IDeclareGetSelfValidationFailuresMethod
    {
        ...
        public override IReadOnlyList<SelfValidationFailure> GetSelfValidationFailures()
        {
            var result = base.GetSelfValidationFailures()
                .Concat(new[]
                    {
                        new { this.Child2NullableCustomEnumValidatedNotDefaultProperty }.ForRecording().Must().NotBeEqualTo((CustomEnumValidatedNotDefault?)CustomEnumValidatedNotDefault.Unknown),
                    }
