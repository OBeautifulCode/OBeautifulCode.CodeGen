// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelValidationPublicSetReadOnlyListOfNullableParent.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public abstract partial class ModelValidationPublicSetReadOnlyListOfNullableParent : IValidatableViaCodeGen, IDeclareGetSelfValidationFailuresMethod
    {
        ...
        public virtual IReadOnlyList<SelfValidationFailure> GetSelfValidationFailures()
        {
            var result = new[]
                {
                    new { this.ParentReadOnlyListInterfaceOfNullableBoolProperty }.ForRecording().Must().NotBeNullNorEmptyEnumerable(),
                    new { this.ParentReadOnlyListInterfaceOfNullableIntProperty }.ForRecording().Must().NotBeNullNorEmptyEnumerable(),
