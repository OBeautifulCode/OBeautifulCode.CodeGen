...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelComparingPublicSettersChild1 : IComparableForRelativeSortOrder<MyModelComparingPublicSettersChild1>
    {
        ...
        public override int CompareTo(object obj)
        {
            ...
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'MyModelComparingPublicSettersChild1' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(MyModelComparingPublicSettersParent other)
        {
            ...
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'MyModelComparingPublicSettersChild1' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }
