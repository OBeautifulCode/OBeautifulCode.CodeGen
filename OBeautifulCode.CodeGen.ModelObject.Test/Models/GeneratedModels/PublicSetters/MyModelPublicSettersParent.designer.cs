...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelPublicSettersParent : IModel<MyModelPublicSettersParent>
    {
        ...
        /// <returns>New <see cref="MyModelPublicSettersParent" /> using the specified <paramref name="parentModelEquatableClassProperty" /> for <see cref="ParentModelEquatableClassProperty" /> and a deep clone of every other property.</returns>
        public abstract MyModelPublicSettersParent DeepCloneWithParentModelEquatableClassProperty(ModelEquatableClass parentModelEquatableClassProperty);
        ...
        /// <returns>New <see cref="MyModelPublicSettersParent" /> using the specified <paramref name="parentReadOnlyListOfModelEquatableClassProperty" /> for <see cref="ParentReadOnlyListOfModelEquatableClassProperty" /> and a deep clone of every other property.</returns>
        public abstract MyModelPublicSettersParent DeepCloneWithParentReadOnlyListOfModelEquatableClassProperty(IReadOnlyList<ModelEquatableClass> parentReadOnlyListOfModelEquatableClassProperty);
