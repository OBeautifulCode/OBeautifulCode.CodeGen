...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelPrivateSettersExpressionBodyChild2 : IModel<MyModelPrivateSettersExpressionBodyChild2>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="MyModelPrivateSettersExpressionBodyChild2"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(MyModelPrivateSettersExpressionBodyChild2 left, MyModelPrivateSettersExpressionBodyChild2 right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="MyModelPrivateSettersExpressionBodyChild2"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(MyModelPrivateSettersExpressionBodyChild2 left, MyModelPrivateSettersExpressionBodyChild2 right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(MyModelPrivateSettersExpressionBodyChild2 other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as MyModelPrivateSettersExpressionBodyChild2);
        ...
        /// <inheritdoc />
        public new MyModelPrivateSettersExpressionBodyChild2 DeepClone() => (MyModelPrivateSettersExpressionBodyChild2)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="MyModelPrivateSettersExpressionBodyChild2" /> using the specified <paramref name="childIntProperty" /> for <see cref="ChildIntProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        public MyModelPrivateSettersExpressionBodyChild2 DeepCloneWithChildIntProperty(int childIntProperty)
        {
            var result = new MyModelPrivateSettersExpressionBodyChild2(
                                 this.ParentIntProperty,
                                 this.ParentStringProperty?.Clone().ToString(),
        ...
        /// <returns>New <see cref="MyModelPrivateSettersExpressionBodyChild2" /> using the specified <paramref name="childStringProperty" /> for <see cref="ChildStringProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        public MyModelPrivateSettersExpressionBodyChild2 DeepCloneWithChildStringProperty(string childStringProperty)
        {
            var result = new MyModelPrivateSettersExpressionBodyChild2(
                                 this.ParentIntProperty,
                                 this.ParentStringProperty?.Clone().ToString(),
        ...
        /// <returns>New <see cref="MyModelPrivateSettersExpressionBodyChild2" /> using the specified <paramref name="childReadOnlyCollectionOfStringProperty" /> for <see cref="ChildReadOnlyCollectionOfStringProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        public MyModelPrivateSettersExpressionBodyChild2 DeepCloneWithChildReadOnlyCollectionOfStringProperty(IReadOnlyCollection<string> childReadOnlyCollectionOfStringProperty)
        {
            var result = new MyModelPrivateSettersExpressionBodyChild2(
                                 this.ParentIntProperty,
                                 this.ParentStringProperty?.Clone().ToString(),
