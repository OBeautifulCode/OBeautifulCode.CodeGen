...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ModelPrivateSetMultipleConstructorsChild1 : IModel<ModelPrivateSetMultipleConstructorsChild1>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPrivateSetMultipleConstructorsChild1"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ModelPrivateSetMultipleConstructorsChild1 left, ModelPrivateSetMultipleConstructorsChild1 right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPrivateSetMultipleConstructorsChild1"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ModelPrivateSetMultipleConstructorsChild1 left, ModelPrivateSetMultipleConstructorsChild1 right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ModelPrivateSetMultipleConstructorsChild1 other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ModelPrivateSetMultipleConstructorsChild1);
        ...
        /// <inheritdoc />
        public new ModelPrivateSetMultipleConstructorsChild1 DeepClone() => (ModelPrivateSetMultipleConstructorsChild1)this.DeepCloneInternal();
        ...
        public override ModelPrivateSetMultipleConstructorsParent DeepCloneWithParentIntProperty(int parentIntProperty)
        {
        ...
        /// <returns>New <see cref="ModelPrivateSetMultipleConstructorsChild1" /> using the specified <paramref name="childIntProperty" /> for <see cref="ChildIntProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPrivateSetMultipleConstructorsChild1 DeepCloneWithChildIntProperty(int childIntProperty)
        {
            var result = new ModelPrivateSetMultipleConstructorsChild1(
                                 this.ParentIntProperty,
                                 this.ParentStringProperty?.DeepClone(),
        ...
        /// <returns>New <see cref="ModelPrivateSetMultipleConstructorsChild1" /> using the specified <paramref name="childStringProperty" /> for <see cref="ChildStringProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPrivateSetMultipleConstructorsChild1 DeepCloneWithChildStringProperty(string childStringProperty)
        {
            var result = new ModelPrivateSetMultipleConstructorsChild1(
                                 this.ParentIntProperty,
                                 this.ParentStringProperty?.DeepClone(),
        ...
        /// <returns>New <see cref="ModelPrivateSetMultipleConstructorsChild1" /> using the specified <paramref name="childReadOnlyCollectionOfStringProperty" /> for <see cref="ChildReadOnlyCollectionOfStringProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPrivateSetMultipleConstructorsChild1 DeepCloneWithChildReadOnlyCollectionOfStringProperty(IReadOnlyCollection<string> childReadOnlyCollectionOfStringProperty)
        {
            var result = new ModelPrivateSetMultipleConstructorsChild1(
                                 this.ParentIntProperty,
                                 this.ParentStringProperty?.DeepClone(),
