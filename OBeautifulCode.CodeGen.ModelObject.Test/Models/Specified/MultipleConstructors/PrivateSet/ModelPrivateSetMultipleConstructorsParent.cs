// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelPrivateSetMultipleConstructorsParent.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public abstract partial class ModelPrivateSetMultipleConstructorsParent : IModelViaCodeGen
    {
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", Justification = ObcSuppressBecause.CA1720_IdentifiersShouldNotContainTypeNames_TypeNameAddedToIdentifierForTestsWhereTypeIsPrimaryConcern)]
        protected ModelPrivateSetMultipleConstructorsParent(
            int parentIntProperty)
            : this(parentIntProperty, "ModelPrivateSetMultipleConstructorsParent-constant")
        {
        }
