// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MyModelPrivateSetMultipleConstructors.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelPrivateSetMultipleConstructors : IModelViaCodeGen
    {
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", Justification = ObcSuppressBecause.CA1720_IdentifiersShouldNotContainTypeNames_TypeNameAddedToIdentifierForTestsWhereTypeIsPrimaryConcern)]
        public MyModelPrivateSetMultipleConstructors(
            int intProperty)
            : this(intProperty, "MyModelPrivateSetMultipleConstructors-constant")
        {
        }
