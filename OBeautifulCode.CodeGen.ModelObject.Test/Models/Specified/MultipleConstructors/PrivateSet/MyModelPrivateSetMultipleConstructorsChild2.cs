// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MyModelPrivateSetMultipleConstructorsChild2.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelPrivateSetMultipleConstructorsChild2 : MyModelPrivateSetMultipleConstructorsParent, IModelViaCodeGen
    {
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", Justification = ObcSuppressBecause.CA1720_IdentifiersShouldNotContainTypeNames_TypeNameAddedToIdentifierForTestsWhereTypeIsPrimaryConcern)]
        public MyModelPrivateSetMultipleConstructorsChild2(
        ...
        public MyModelPrivateSetMultipleConstructorsChild2(
            ...
            int childIntProperty)
            : this(parentIntProperty, parentStringProperty, parentReadOnlyCollectionOfStringProperty, childIntProperty, "MyModelPrivateSetMultipleConstructorsChild2-constant")
        {
        }
