// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MyModelPrivateSetMultipleConstructorsParent.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public abstract partial class MyModelPrivateSetMultipleConstructorsParent : IModelViaCodeGen
    {
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", Justification = ObcSuppressBecause.CA1720_IdentifiersShouldNotContainTypeNames_TypeNameAddedToIdentifierForTestsWhereTypeIsPrimaryConcern)]
        protected MyModelPrivateSetMultipleConstructorsParent(
            int parentIntProperty)
            : this(parentIntProperty, "MyModelPrivateSetMultipleConstructorsParent-constant")
        {
        }
