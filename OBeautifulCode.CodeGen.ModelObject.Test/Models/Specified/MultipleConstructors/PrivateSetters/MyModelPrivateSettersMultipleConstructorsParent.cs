// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MyModelPrivateSettersMultipleConstructorsParent.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public abstract partial class MyModelPrivateSettersMultipleConstructorsParent : IModelViaCodeGen
    {
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", Justification = ObcSuppressBecause.CA1720_IdentifiersShouldNotContainTypeNames_TypeNameAddedToIdentifierForTestsWhereTypeIsPrimaryConcern)]
        protected MyModelPrivateSettersMultipleConstructorsParent(
            int parentIntProperty)
            : this(parentIntProperty, "MyModelPrivateSettersMultipleConstructorsParent-constant")
        {
        }
        ...
        protected MyModelPrivateSettersMultipleConstructorsParent(
            ...
            : this(parentIntProperty, parentStringProperty, new[] { parentStringProperty })
        {
        }
