// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MyModelPrivateSettersMultipleConstructorsChild2.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelPrivateSettersMultipleConstructorsChild2 : MyModelPrivateSettersMultipleConstructorsParent, IModelViaCodeGen
    {
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", Justification = ObcSuppressBecause.CA1720_IdentifiersShouldNotContainTypeNames_TypeNameAddedToIdentifierForTestsWhereTypeIsPrimaryConcern)]
        public MyModelPrivateSettersMultipleConstructorsChild2(
        ...
        public MyModelPrivateSettersMultipleConstructorsChild2(
            ...
            int childIntProperty)
            : this(parentIntProperty, parentStringProperty, parentReadOnlyCollectionOfStringProperty, childIntProperty, "MyModelPrivateSettersMultipleConstructorsChild2-constant")
        {
        }
