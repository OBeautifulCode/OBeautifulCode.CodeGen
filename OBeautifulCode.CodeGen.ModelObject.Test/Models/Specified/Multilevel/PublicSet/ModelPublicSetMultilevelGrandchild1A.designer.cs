...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ModelPublicSetMultilevelGrandchild1A : IModel<ModelPublicSetMultilevelGrandchild1A>, IComparableForRelativeSortOrder<ModelPublicSetMultilevelGrandchild1A>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPublicSetMultilevelGrandchild1A"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ModelPublicSetMultilevelGrandchild1A left, ModelPublicSetMultilevelGrandchild1A right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPublicSetMultilevelGrandchild1A"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ModelPublicSetMultilevelGrandchild1A left, ModelPublicSetMultilevelGrandchild1A right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ModelPublicSetMultilevelGrandchild1A other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ModelPublicSetMultilevelGrandchild1A);

        /// <summary>
        /// Determines whether an object of type <see cref="ModelPublicSetMultilevelGrandchild1A"/> is less than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPublicSetMultilevelGrandchild1A"/> is greater than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPublicSetMultilevelGrandchild1A"/> is less than or equal to another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPublicSetMultilevelGrandchild1A"/> is greater than or equal to another object of that type.
        /// </summary>
        ...
        /// <inheritdoc />
        public int CompareTo(ModelPublicSetMultilevelGrandchild1A other)
        {
            if (ReferenceEquals(other, null))
            {
                return 1;
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (!(obj is ModelPublicSetMultilevelGrandchild1A other))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'ModelPublicSetMultilevelGrandchild1A' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(ModelPublicSetMultilevelParent other)
        {
            ...
            if (!(other is ModelPublicSetMultilevelGrandchild1A otherAsModelPublicSetMultilevelGrandchild1A))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'ModelPublicSetMultilevelGrandchild1A' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }

            var result = this.CompareToForRelativeSortOrder(otherAsModelPublicSetMultilevelGrandchild1A);
        ...
        /// <inheritdoc />
        public new ModelPublicSetMultilevelGrandchild1A DeepClone() => (ModelPublicSetMultilevelGrandchild1A)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="ModelPublicSetMultilevelGrandchild1A" /> using the specified <paramref name="grandchild1AInt" /> for <see cref="Grandchild1AInt" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPublicSetMultilevelGrandchild1A DeepCloneWithGrandchild1AInt(int grandchild1AInt)
        {
            var result = new ModelPublicSetMultilevelGrandchild1A
                             {
                                 ParentInt       = this.ParentInt.DeepClone(),
        ...
        {
            var result = Invariant($"OBeautifulCode.CodeGen.ModelObject.Test.ModelPublicSetMultilevelGrandchild1A: ParentInt = {this.ParentInt.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Child1Int = {this.Child1Int.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Grandchild1AInt = {this.Grandchild1AInt.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
