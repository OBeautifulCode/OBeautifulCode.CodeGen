...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ModelPublicSetMultilevelGrandchild2A : IModel<ModelPublicSetMultilevelGrandchild2A>, IComparableForRelativeSortOrder<ModelPublicSetMultilevelGrandchild2A>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPublicSetMultilevelGrandchild2A"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ModelPublicSetMultilevelGrandchild2A left, ModelPublicSetMultilevelGrandchild2A right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPublicSetMultilevelGrandchild2A"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ModelPublicSetMultilevelGrandchild2A left, ModelPublicSetMultilevelGrandchild2A right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ModelPublicSetMultilevelGrandchild2A other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ModelPublicSetMultilevelGrandchild2A);

        /// <summary>
        /// Determines whether an object of type <see cref="ModelPublicSetMultilevelGrandchild2A"/> is less than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPublicSetMultilevelGrandchild2A"/> is greater than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPublicSetMultilevelGrandchild2A"/> is less than or equal to another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPublicSetMultilevelGrandchild2A"/> is greater than or equal to another object of that type.
        /// </summary>
        ...
        /// <inheritdoc />
        public int CompareTo(ModelPublicSetMultilevelGrandchild2A other)
        {
            if (ReferenceEquals(other, null))
            {
                return 1;
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (!(obj is ModelPublicSetMultilevelGrandchild2A other))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'ModelPublicSetMultilevelGrandchild2A' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(ModelPublicSetMultilevelParent other)
        {
            ...
            if (!(other is ModelPublicSetMultilevelGrandchild2A otherAsModelPublicSetMultilevelGrandchild2A))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'ModelPublicSetMultilevelGrandchild2A' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }

            var result = this.CompareToForRelativeSortOrder(otherAsModelPublicSetMultilevelGrandchild2A);
        ...
        /// <inheritdoc />
        public new ModelPublicSetMultilevelGrandchild2A DeepClone() => (ModelPublicSetMultilevelGrandchild2A)this.DeepCloneInternal();
        ...
        {
            var result = new ModelPublicSetMultilevelGrandchild2A
                             {
                                 ParentInt       = parentInt,
                                 Child2Int       = this.Child2Int.DeepClone(),
                                 Grandchild2AInt = this.Grandchild2AInt.DeepClone(),
                             };
        ...
        /// <returns>New <see cref="ModelPublicSetMultilevelGrandchild2A" /> using the specified <paramref name="grandchild2AInt" /> for <see cref="Grandchild2AInt" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPublicSetMultilevelGrandchild2A DeepCloneWithGrandchild2AInt(int grandchild2AInt)
        {
            var result = new ModelPublicSetMultilevelGrandchild2A
                             {
                                 ParentInt       = this.ParentInt.DeepClone(),
        ...
        {
            var result = Invariant($"OBeautifulCode.CodeGen.ModelObject.Test.ModelPublicSetMultilevelGrandchild2A: ParentInt = {this.ParentInt.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Child2Int = {this.Child2Int.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Grandchild2AInt = {this.Grandchild2AInt.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
