// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MyModelPrivateSetMultilevelGrandchild1B.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelPrivateSetMultilevelGrandchild1B : MyModelPrivateSetMultilevelChild1, IModelViaCodeGen, IComparableViaCodeGen, IDeclareCompareToForRelativeSortOrderMethod<MyModelPrivateSetMultilevelGrandchild1B>
    {
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", Justification = ObcSuppressBecause.CA1720_IdentifiersShouldNotContainTypeNames_TypeNameAddedToIdentifierForTestsWhereTypeIsPrimaryConcern)]
        public MyModelPrivateSetMultilevelGrandchild1B(
            int parentInt,
            int child1Int,
            int grandchild1BInt)
        ...
        public RelativeSortOrder CompareToForRelativeSortOrder(
            MyModelPrivateSetMultilevelGrandchild1B other)
        {
            if (other == null)
            {
