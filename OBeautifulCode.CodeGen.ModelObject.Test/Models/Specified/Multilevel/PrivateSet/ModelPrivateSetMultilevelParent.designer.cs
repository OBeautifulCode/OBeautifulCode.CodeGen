...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class ModelPrivateSetMultilevelParent : IModel<ModelPrivateSetMultilevelParent>, IComparableForRelativeSortOrder<ModelPrivateSetMultilevelParent>
    {
        ...
        /// <inheritdoc />
        public virtual RelativeSortOrder CompareToForRelativeSortOrder(ModelPrivateSetMultilevelParent other)
        {
            throw new NotImplementedException("This method should be abstract.  It was generated as virtual so that you aren't forced to override it when you create a new model that derives from this model.  It will be overridden in the generated designer file.");
        }
        ...
        public virtual ModelPrivateSetMultilevelParent DeepCloneWithParentInt(int parentInt)
        {
            throw new NotImplementedException("This method should be abstract.  It was generated as virtual so that you aren't forced to override it when you create a new model that derives from this model.  It will be overridden in the generated designer file.");
        }
        ...
        /// </returns>
        protected virtual ModelPrivateSetMultilevelParent DeepCloneInternal()
        {
            throw new NotImplementedException("This method should be abstract.  It was generated as virtual so that you aren't forced to override it when you create a new model that derives from this model.  It will be overridden in the generated designer file.");
        }
