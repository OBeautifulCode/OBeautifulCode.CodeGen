...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ModelPrivateSetMultilevelGrandchild2A : IModel<ModelPrivateSetMultilevelGrandchild2A>, IComparableForRelativeSortOrder<ModelPrivateSetMultilevelGrandchild2A>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPrivateSetMultilevelGrandchild2A"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ModelPrivateSetMultilevelGrandchild2A left, ModelPrivateSetMultilevelGrandchild2A right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPrivateSetMultilevelGrandchild2A"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ModelPrivateSetMultilevelGrandchild2A left, ModelPrivateSetMultilevelGrandchild2A right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ModelPrivateSetMultilevelGrandchild2A other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ModelPrivateSetMultilevelGrandchild2A);

        /// <summary>
        /// Determines whether an object of type <see cref="ModelPrivateSetMultilevelGrandchild2A"/> is less than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPrivateSetMultilevelGrandchild2A"/> is greater than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPrivateSetMultilevelGrandchild2A"/> is less than or equal to another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPrivateSetMultilevelGrandchild2A"/> is greater than or equal to another object of that type.
        /// </summary>
        ...
        /// <inheritdoc />
        public int CompareTo(ModelPrivateSetMultilevelGrandchild2A other)
        {
            if (ReferenceEquals(other, null))
            {
                return 1;
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (!(obj is ModelPrivateSetMultilevelGrandchild2A other))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'ModelPrivateSetMultilevelGrandchild2A' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(ModelPrivateSetMultilevelParent other)
        {
            ...
            if (!(other is ModelPrivateSetMultilevelGrandchild2A otherAsModelPrivateSetMultilevelGrandchild2A))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'ModelPrivateSetMultilevelGrandchild2A' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }

            var result = this.CompareToForRelativeSortOrder(otherAsModelPrivateSetMultilevelGrandchild2A);
        ...
        /// <inheritdoc />
        public new ModelPrivateSetMultilevelGrandchild2A DeepClone() => (ModelPrivateSetMultilevelGrandchild2A)this.DeepCloneInternal();
        ...
        {
            var result = new ModelPrivateSetMultilevelGrandchild2A(
                                 parentInt,
                                 this.Child2Int.DeepClone(),
                                 this.Grandchild2AInt.DeepClone());
        ...
        /// <returns>New <see cref="ModelPrivateSetMultilevelGrandchild2A" /> using the specified <paramref name="grandchild2AInt" /> for <see cref="Grandchild2AInt" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPrivateSetMultilevelGrandchild2A DeepCloneWithGrandchild2AInt(int grandchild2AInt)
        {
            var result = new ModelPrivateSetMultilevelGrandchild2A(
                                 this.ParentInt.DeepClone(),
                                 this.Child2Int.DeepClone(),
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Grandchild2AInt, options, propertyPathTracker, nameof(this.Grandchild2AInt));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
