...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ModelPrivateSetMultilevelGrandchild1B : IModel<ModelPrivateSetMultilevelGrandchild1B>, IComparableForRelativeSortOrder<ModelPrivateSetMultilevelGrandchild1B>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPrivateSetMultilevelGrandchild1B"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ModelPrivateSetMultilevelGrandchild1B left, ModelPrivateSetMultilevelGrandchild1B right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPrivateSetMultilevelGrandchild1B"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ModelPrivateSetMultilevelGrandchild1B left, ModelPrivateSetMultilevelGrandchild1B right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ModelPrivateSetMultilevelGrandchild1B other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ModelPrivateSetMultilevelGrandchild1B);

        /// <summary>
        /// Determines whether an object of type <see cref="ModelPrivateSetMultilevelGrandchild1B"/> is less than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPrivateSetMultilevelGrandchild1B"/> is greater than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPrivateSetMultilevelGrandchild1B"/> is less than or equal to another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="ModelPrivateSetMultilevelGrandchild1B"/> is greater than or equal to another object of that type.
        /// </summary>
        ...
        /// <inheritdoc />
        public int CompareTo(ModelPrivateSetMultilevelGrandchild1B other)
        {
            if (ReferenceEquals(other, null))
            {
                return 1;
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (!(obj is ModelPrivateSetMultilevelGrandchild1B other))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'ModelPrivateSetMultilevelGrandchild1B' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(ModelPrivateSetMultilevelParent other)
        {
            ...
            if (!(other is ModelPrivateSetMultilevelGrandchild1B otherAsModelPrivateSetMultilevelGrandchild1B))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'ModelPrivateSetMultilevelGrandchild1B' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }

            var result = this.CompareToForRelativeSortOrder(otherAsModelPrivateSetMultilevelGrandchild1B);
        ...
        /// <inheritdoc />
        public new ModelPrivateSetMultilevelGrandchild1B DeepClone() => (ModelPrivateSetMultilevelGrandchild1B)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="ModelPrivateSetMultilevelGrandchild1B" /> using the specified <paramref name="grandchild1BInt" /> for <see cref="Grandchild1BInt" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Grandchild1BInt, options, propertyPathTracker, nameof(this.Grandchild1BInt));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
