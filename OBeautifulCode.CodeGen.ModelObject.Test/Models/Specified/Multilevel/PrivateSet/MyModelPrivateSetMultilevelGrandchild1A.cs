// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MyModelPrivateSetMultilevelGrandchild1A.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelPrivateSetMultilevelGrandchild1A : MyModelPrivateSetMultilevelChild1, IModelViaCodeGen, IComparableViaCodeGen, IDeclareCompareToForRelativeSortOrderMethod<MyModelPrivateSetMultilevelGrandchild1A>
    {
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", Justification = ObcSuppressBecause.CA1720_IdentifiersShouldNotContainTypeNames_TypeNameAddedToIdentifierForTestsWhereTypeIsPrimaryConcern)]
        public MyModelPrivateSetMultilevelGrandchild1A(
            int parentInt,
            int child1Int,
            int grandchild1AInt)
        ...
        public RelativeSortOrder CompareToForRelativeSortOrder(
            MyModelPrivateSetMultilevelGrandchild1A other)
        {
            if (other == null)
            {
