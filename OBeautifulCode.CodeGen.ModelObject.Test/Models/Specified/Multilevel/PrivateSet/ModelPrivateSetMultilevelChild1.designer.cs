...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class ModelPrivateSetMultilevelChild1 : IModel<ModelPrivateSetMultilevelChild1>, IComparableForRelativeSortOrder<ModelPrivateSetMultilevelChild1>
    {
        ...
        /// <inheritdoc />
        public virtual RelativeSortOrder CompareToForRelativeSortOrder(ModelPrivateSetMultilevelChild1 other)
        {
            throw new NotImplementedException("This method should be abstract.  It was generated as virtual so that you aren't forced to override it when you create a new model that derives from this model.  It will be overridden in the generated designer file.");
        }
        ...
        public virtual ModelPrivateSetMultilevelChild1 DeepCloneWithChild1Int(int child1Int)
        {
            throw new NotImplementedException("This method should be abstract.  It was generated as virtual so that you aren't forced to override it when you create a new model that derives from this model.  It will be overridden in the generated designer file.");
        }
