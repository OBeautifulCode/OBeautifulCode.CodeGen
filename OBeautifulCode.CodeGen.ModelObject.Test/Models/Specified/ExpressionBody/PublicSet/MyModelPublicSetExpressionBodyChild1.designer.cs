...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class MyModelPublicSetExpressionBodyChild1 : IModel<MyModelPublicSetExpressionBodyChild1>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="MyModelPublicSetExpressionBodyChild1"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(MyModelPublicSetExpressionBodyChild1 left, MyModelPublicSetExpressionBodyChild1 right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="MyModelPublicSetExpressionBodyChild1"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(MyModelPublicSetExpressionBodyChild1 left, MyModelPublicSetExpressionBodyChild1 right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(MyModelPublicSetExpressionBodyChild1 other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as MyModelPublicSetExpressionBodyChild1);
        ...
        /// <inheritdoc />
        public new MyModelPublicSetExpressionBodyChild1 DeepClone() => (MyModelPublicSetExpressionBodyChild1)this.DeepCloneInternal();
        ...
        {
            var result = new MyModelPublicSetExpressionBodyChild1
                             {
        ...
        /// <returns>New <see cref="MyModelPublicSetExpressionBodyChild1" /> using the specified <paramref name="childIntProperty" /> for <see cref="ChildIntProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        public MyModelPublicSetExpressionBodyChild1 DeepCloneWithChildIntProperty(int childIntProperty)
        {
            var result = new MyModelPublicSetExpressionBodyChild1
                             {
                                 ParentIntProperty                        = this.ParentIntProperty,
        ...
        /// <returns>New <see cref="MyModelPublicSetExpressionBodyChild1" /> using the specified <paramref name="childStringProperty" /> for <see cref="ChildStringProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        public MyModelPublicSetExpressionBodyChild1 DeepCloneWithChildStringProperty(string childStringProperty)
        {
            var result = new MyModelPublicSetExpressionBodyChild1
                             {
                                 ParentIntProperty                        = this.ParentIntProperty,
        ...
        /// <returns>New <see cref="MyModelPublicSetExpressionBodyChild1" /> using the specified <paramref name="childReadOnlyCollectionOfStringProperty" /> for <see cref="ChildReadOnlyCollectionOfStringProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        public MyModelPublicSetExpressionBodyChild1 DeepCloneWithChildReadOnlyCollectionOfStringProperty(IReadOnlyCollection<string> childReadOnlyCollectionOfStringProperty)
        {
            var result = new MyModelPublicSetExpressionBodyChild1
                             {
                                 ParentIntProperty                        = this.ParentIntProperty,
