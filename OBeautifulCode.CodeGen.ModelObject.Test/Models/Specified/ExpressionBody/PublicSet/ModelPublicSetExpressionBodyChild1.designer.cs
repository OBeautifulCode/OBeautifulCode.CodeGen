...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ModelPublicSetExpressionBodyChild1 : IModel<ModelPublicSetExpressionBodyChild1>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPublicSetExpressionBodyChild1"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ModelPublicSetExpressionBodyChild1 left, ModelPublicSetExpressionBodyChild1 right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPublicSetExpressionBodyChild1"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ModelPublicSetExpressionBodyChild1 left, ModelPublicSetExpressionBodyChild1 right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ModelPublicSetExpressionBodyChild1 other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ModelPublicSetExpressionBodyChild1);
        ...
        /// <inheritdoc />
        public new ModelPublicSetExpressionBodyChild1 DeepClone() => (ModelPublicSetExpressionBodyChild1)this.DeepCloneInternal();
        ...
        {
            var result = new ModelPublicSetExpressionBodyChild1
                             {
                                 ParentIntProperty                        = parentIntProperty,
                                 ParentStringProperty                     = this.ParentStringProperty?.DeepClone(),
                                 ParentReadOnlyCollectionOfStringProperty = this.ParentReadOnlyCollectionOfStringProperty?.DeepClone(),
                                 ChildIntProperty                         = this.ChildIntProperty.DeepClone(),
                                 ChildStringProperty                      = this.ChildStringProperty?.DeepClone(),
                                 ChildReadOnlyCollectionOfStringProperty  = this.ChildReadOnlyCollectionOfStringProperty?.DeepClone(),
                             };
        ...
        /// <returns>New <see cref="ModelPublicSetExpressionBodyChild1" /> using the specified <paramref name="childIntProperty" /> for <see cref="ChildIntProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPublicSetExpressionBodyChild1 DeepCloneWithChildIntProperty(int childIntProperty)
        {
            var result = new ModelPublicSetExpressionBodyChild1
                             {
                                 ParentIntProperty                        = this.ParentIntProperty.DeepClone(),
        ...
        /// <returns>New <see cref="ModelPublicSetExpressionBodyChild1" /> using the specified <paramref name="childStringProperty" /> for <see cref="ChildStringProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPublicSetExpressionBodyChild1 DeepCloneWithChildStringProperty(string childStringProperty)
        {
            var result = new ModelPublicSetExpressionBodyChild1
                             {
                                 ParentIntProperty                        = this.ParentIntProperty.DeepClone(),
        ...
        /// <returns>New <see cref="ModelPublicSetExpressionBodyChild1" /> using the specified <paramref name="childReadOnlyCollectionOfStringProperty" /> for <see cref="ChildReadOnlyCollectionOfStringProperty" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ModelPublicSetExpressionBodyChild1 DeepCloneWithChildReadOnlyCollectionOfStringProperty(IReadOnlyCollection<string> childReadOnlyCollectionOfStringProperty)
        {
            var result = new ModelPublicSetExpressionBodyChild1
                             {
                                 ParentIntProperty                        = this.ParentIntProperty.DeepClone(),
