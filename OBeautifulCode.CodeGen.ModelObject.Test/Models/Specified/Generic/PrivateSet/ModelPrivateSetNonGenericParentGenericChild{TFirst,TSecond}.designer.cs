    ...
    public partial class ModelPrivateSetNonGenericParentGenericChild<TFirst, TSecond> : IModel<ModelPrivateSetNonGenericParentGenericChild<TFirst, TSecond>>, IComparableForRelativeSortOrder<ModelPrivateSetNonGenericParentGenericChild<TFirst, TSecond>>
    {
        ...
        public override ModelPrivateSetNonGenericParent DeepCloneWithParentStringProperty(string parentStringProperty)
        {
            var result = new ModelPrivateSetNonGenericParentGenericChild<TFirst, TSecond>(
                                 ...
                                 this.ParentArrayProperty?.DeepClone(),
                                 this.ParentNullableProperty?.DeepClone(),
                                 this.ParentCustomGenericClassProperty?.DeepClone(),
                                 this.ParentReadOnlyCollectionProperty?.DeepClone(),
                                 this.ParentReadOnlyDictionaryProperty?.DeepClone(),
