            ...
            var result = new ModelPublicSetGenericParentNonGenericChild
                             {
                                 ...
                                 ChildArrayProperty                                      = this.ChildArrayProperty?.DeepClone(),
                                 ChildNullableProperty                                   = this.ChildNullableProperty?.DeepClone(),
                                 ChildCustomGenericClassProperty                         = this.ChildCustomGenericClassProperty?.DeepClone(),
                                 ChildReadOnlyCollectionProperty                         = this.ChildReadOnlyCollectionProperty?.DeepClone(),
                                 ChildReadOnlyDictionaryProperty                         = this.ChildReadOnlyDictionaryProperty?.DeepClone(),
                             };
