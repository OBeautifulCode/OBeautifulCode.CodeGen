...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ModelPrivateSetNotEmptyParentEmptyChild : IModel<ModelPrivateSetNotEmptyParentEmptyChild>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPrivateSetNotEmptyParentEmptyChild"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ModelPrivateSetNotEmptyParentEmptyChild left, ModelPrivateSetNotEmptyParentEmptyChild right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ModelPrivateSetNotEmptyParentEmptyChild"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ModelPrivateSetNotEmptyParentEmptyChild left, ModelPrivateSetNotEmptyParentEmptyChild right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ModelPrivateSetNotEmptyParentEmptyChild other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ModelPrivateSetNotEmptyParentEmptyChild);
        ...
        /// <inheritdoc />
        public new ModelPrivateSetNotEmptyParentEmptyChild DeepClone() => (ModelPrivateSetNotEmptyParentEmptyChild)this.DeepCloneInternal();
        ...
        public override ModelPrivateSetNotEmptyParent DeepCloneWithParentReadOnlyDictionaryOfStringString(IReadOnlyDictionary<string, string> parentReadOnlyDictionaryOfStringString)
        {
        ...
        {
            var result = new ModelPrivateSetNotEmptyParentEmptyChild(
                                 this.ParentReadOnlyDictionaryOfStringString?.DeepClone());
        ...
        {
            var result = Invariant($"OBeautifulCode.CodeGen.ModelObject.Test.ModelPrivateSetNotEmptyParentEmptyChild: ParentReadOnlyDictionaryOfStringString = {this.ParentReadOnlyDictionaryOfStringString?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ParentReadOnlyDictionaryOfStringString, options, propertyPathTracker, nameof(this.ParentReadOnlyDictionaryOfStringString));
