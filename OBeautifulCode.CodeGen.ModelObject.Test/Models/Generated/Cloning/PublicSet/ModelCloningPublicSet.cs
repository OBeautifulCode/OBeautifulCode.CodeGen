// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelCloningPublicSet.cs" company="OBeautifulCode">
...
#pragma warning disable CS0661
    public partial class ModelCloningPublicSet : IDeepCloneableViaCodeGen, IDeclareDeepCloneMethod<ModelCloningPublicSet>, IEquatable<ModelCloningPublicSet>
#pragma warning disable CS0659
#pragma warning disable CS0661
    {
        ...
        /// <inheritdoc />
        public bool Equals(ModelCloningPublicSet other)
        {
        ...
        /// <inheritdoc />
        public ModelCloningPublicSet DeepClone()
        {
        ...
        private ModelCloningPublicSet DeepCloneImplementation()
        {
            var referenceModel = A.Dummy<ModelAllPublicSet>();
            ...
            referenceModel = (ModelAllPublicSet)referenceModel.GetType().GetMethod("DeepClone").Invoke(referenceModel, new object[0]);

            var thisModelProperties = this.GetType().GetProperties();

            var result = A.Dummy<ModelCloningPublicSet>();
