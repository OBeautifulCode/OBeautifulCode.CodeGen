// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelComparingPublicSetChild2.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class ModelComparingPublicSetChild2 : ModelComparingPublicSetParent, IComparableViaCodeGen, IDeclareCompareToForRelativeSortOrderMethod<ModelComparingPublicSetChild2>
    {
        ...
        /// <inheritdoc />
        public RelativeSortOrder CompareToForRelativeSortOrder(ModelComparingPublicSetChild2 other)
        {
            if (other == null)
            {
