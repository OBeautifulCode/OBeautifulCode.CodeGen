...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    public partial class MyModelPublicSettersEmptyParentEmptyChild : IModel<MyModelPublicSettersEmptyParentEmptyChild>
    {
        ...
        /// <inheritdoc />
        public bool Equals(MyModelPublicSettersEmptyParentEmptyChild other) => this == other;
        ...
        {
            var result = ((IDeepCloneable<MyModelPublicSettersEmptyParentEmptyChild>)this).DeepClone();

            return result;
        }

        /// <inheritdoc />
        MyModelPublicSettersEmptyParentEmptyChild IDeepCloneable<MyModelPublicSettersEmptyParentEmptyChild>.DeepClone()
        {
