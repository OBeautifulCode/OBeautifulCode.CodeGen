...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ValidatableComboProperties : IValidatable
    {
        /// <inheritdoc />
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.StringValue1, options, propertyPathTracker, nameof(this.StringValue1));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.StringValue2, options, propertyPathTracker, nameof(this.StringValue2));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
