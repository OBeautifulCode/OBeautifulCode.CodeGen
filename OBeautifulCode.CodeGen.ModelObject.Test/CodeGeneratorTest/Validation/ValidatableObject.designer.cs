...
namespace OBeautifulCode.CodeGen.ModelObject.Test
{
    ...
    [Serializable]
    public partial class ValidatableObject : IValidatable
    {
        /// <inheritdoc />
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidatableNumber1, options, propertyPathTracker, nameof(this.ValidatableNumber1));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidatableText1, options, propertyPathTracker, nameof(this.ValidatableText1));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidatableNumber2, options, propertyPathTracker, nameof(this.ValidatableNumber2));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidatableText2, options, propertyPathTracker, nameof(this.ValidatableText2));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidatableNumbers1, options, propertyPathTracker, nameof(this.ValidatableNumbers1));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidatableTexts1, options, propertyPathTracker, nameof(this.ValidatableTexts1));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidatableNumbers2, options, propertyPathTracker, nameof(this.ValidatableNumbers2));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidatableTexts2, options, propertyPathTracker, nameof(this.ValidatableTexts2));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
