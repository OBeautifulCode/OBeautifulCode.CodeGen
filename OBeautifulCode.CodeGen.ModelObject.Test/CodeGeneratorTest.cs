    ...
    public class CodeGeneratorTest
    {
        ...
        public void GenerateForModel___Should_throw_NotSupportedException___When_model_type_not_supported()
        {
            ...
            var tests = new[]
            {
                ...
                new { Type = typeof(HasNonInterfaceCollectionProperty1), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Collection type that is not an interface" },
                new { Type = typeof(HasNonInterfaceCollectionProperty2), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Collection type that is not an interface" },
                new { Type = typeof(HasNonInterfaceCollectionProperty3), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Collection type that is not an interface" },
                new { Type = typeof(HasNonInterfaceCollectionProperty4), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Collection type that is not an interface" },
                new { Type = typeof(HasNonInterfaceCollectionProperty5), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Collection type that is not an interface" },
                new { Type = typeof(HasNonInterfaceCollectionProperty6), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Collection type that is not an interface" },
                new { Type = typeof(HasNonInterfaceDictionaryProperty1), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Dictionary type that is not an interface" },
                new { Type = typeof(HasNonInterfaceDictionaryProperty2), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Dictionary type that is not an interface" },
                new { Type = typeof(HasNonInterfaceDictionaryProperty3), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Dictionary type that is not an interface" },
                new { Type = typeof(HasNonInterfaceDictionaryProperty4), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Dictionary type that is not an interface" },
                new { Type = typeof(HasNonInterfaceDictionaryProperty5), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Dictionary type that is not an interface" },
                new { Type = typeof(HasNonInterfaceDictionaryProperty6), ExpectedExceptionMessageContains = "it contains one or more properties that are OR have within their generic argument tree or array element type a closed System Dictionary type that is not an interface" },
